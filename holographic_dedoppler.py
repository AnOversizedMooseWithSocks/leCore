...
from holographic_ai import permute        # the engine's cyclic shift = the de-drift step (== bind by a shifted delta)
from holographic_honesty import bh_fdr     # the look-elsewhere / trials-factor control (Benjamini-Yekutieli)
