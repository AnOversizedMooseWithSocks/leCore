...
class Compute:
    ...
    def leaf(v):
        ...
        from holographic_fuse import leaf
        return leaf(v)

    @staticmethod
    def bind(x, y):
        from holographic_fuse import fbind
        return fbind(x, y)

    @staticmethod
    def unbind(x, y):
        from holographic_fuse import funbind
        return funbind(x, y)

    @staticmethod
    def bundle(children):
        from holographic_fuse import fbundle
    ...
    @staticmethod
    def permute(x, shift):
        from holographic_fuse import fpermute
    ...
    def reset_fft_counts():
        ...
        from holographic_fuse import reset_fft_counts
        reset_fft_counts()
    ...
    def fft_counts():
        ...
        from holographic_fuse import fft_counts
        return fft_counts()
    ...
    def run_scheduled(ops, min_run=2, spectrum_cache=None):
        ...
        from holographic_schedule import run_scheduled
    ...
    def iterate(op, state, k, min_k=8, probes=3, seed=0):
        ...
        from holographic_iterate import iterate_gated
