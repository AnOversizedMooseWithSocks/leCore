...
from holographic_quantities import (
    Quantity, unit, register_unit, _dim, _dim_str, BASE,
    body_mass, bill_mass, bill_cost, bill_embodied_carbon,
...
def test_body_mass_reuses_density_ingredient(lib):
    ...
    from holographic_quantities import quantity_from_definition
