...
from holographic_gbuffer import primary_gbuffer, render_denoised, declfirefly
...
def test_render_dispersion_splits_the_refracted_channels():
    from holographic_gbuffer import render_auto, render_dispersion
...
def test_add_caustics_brightens_floor_only():
    from holographic_gbuffer import add_caustics
