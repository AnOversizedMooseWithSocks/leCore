...
RUN_ROOT=/opt/qwen35-acceptance-v5
...
PREFIX=qwen35-acceptance/d5bcfc2-2fc06364-a6c9d113/v5-formal
LECORE_COMMIT=d5bcfc297a3af8e4f8f0c60b3d8ad21b67e0e55a
...
LAUNCH_SHA=38c88e34eeb13b2c6bf05785235341cd574f2296cac3deb9b2adbce46f1b7123
STAGE=boot
...
with open(path, "w", encoding="utf-8") as handle:
    json.dump({
        "schema": "lecore.qwen35-runner-status.v5",
        "stage": stage,
        "exit_code": int(exit_code),
        "formal_run_started": formal == "true",
        "experiment_id": experiment_id or None,
        "source_commit": "d5bcfc297a3af8e4f8f0c60b3d8ad21b67e0e55a",
...
"${PYTHON}" "${LECORE_DIR}/experiments/qwen35_acceptance/generate.py" \
  ...
  --experiment-version 5 --initial-chunk-size 128 \
...
checks = {
    ...
    "experiment_version": project["experiment_version"] == 5 and project["experiment_id"].endswith(".v5.acceptance"),
    ...
    "checker_version": experiment["evidence_authority"]["provenance"]["checker"] == "checker://lecore/qwen35-acceptance/%s/v5" % policy_digest,
    ...
    "progress_bound": policy["telemetry"]["progress_upload_uri"] == "s3://zero-training-022118847419/qwen35-acceptance/d5bcfc2-2fc06364-a6c9d113/v5-formal/progress.jsonl",
    "launch_source": launch["source"]["commit"] == source_commit,
    "launch_attempt": launch["attempt"]["experiment_version"] == 5 and launch["attempt"]["maximum_formal_runs"] == 1 and launch["attempt"]["retry_after_admission"] is False,
...
payload = {
    "schema": "lecore.qwen35-execution-summary.v5",
