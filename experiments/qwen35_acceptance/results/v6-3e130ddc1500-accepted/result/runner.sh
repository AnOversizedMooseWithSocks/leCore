...
RUN_ROOT=/opt/qwen35-acceptance-v6
...
PREFIX=qwen35-acceptance/3e130dd-2fc06364-a6c9d113/v6-formal
LECORE_COMMIT=3e130ddc1500af084eb7a7fe94a5da647b0ff3ef
ILXYR_COMMIT=e92382ff2a5e8714466533a160f6609b4ef9cee8
MODEL_REVISION=2fc06364715b967f1860aea9cf38778875588b17
INSTALL_SHA=0215736e206074878767647d2c4320457f958475630eeae4743dacb5d7ed8a6b
...
LAUNCH_SHA=2a93f8bfb176ff57986218a9f7c5771c10c10313ba818540c92eabdf2af6f670
STAGE=boot
...
# this fires. Six and a half hours of r7i.4xlarge compute is $6.8796;
# combined with the estimated $2.84 already spent, this stays below $10.
shutdown -h +390
...
with open(path, "w", encoding="utf-8") as handle:
    json.dump({
        "schema": "lecore.qwen35-runner-status.v6",
        "stage": stage,
        "exit_code": int(exit_code),
        "formal_run_started": formal == "true",
        "experiment_id": experiment_id or None,
        "source_commit": "3e130ddc1500af084eb7a7fe94a5da647b0ff3ef",
...
"${PYTHON}" "${LECORE_DIR}/tools/benchmark_qwen_runtime.py" \
  ...
  --full-run-peak-mib 24306.52734375 \
...
"${PYTHON}" "${LECORE_DIR}/experiments/qwen35_acceptance/generate.py" \
  ...
  --experiment-version 6 --initial-chunk-size 128 \
...
checks = {
    ...
    "experiment_version": project["experiment_version"] == 6 and project["experiment_id"].endswith(".v6.acceptance"),
    ...
    "checker_version": experiment["evidence_authority"]["provenance"]["checker"] == "checker://lecore/qwen35-acceptance/%s/v6" % policy_digest,
    ...
    "progress_bound": policy["telemetry"]["progress_upload_uri"] == "s3://zero-training-022118847419/qwen35-acceptance/3e130dd-2fc06364-a6c9d113/v6-formal/progress.jsonl",
    "launch_source": launch["source"]["commit"] == source_commit,
    "launch_attempt": launch["attempt"]["experiment_version"] == 6 and launch["attempt"]["maximum_formal_runs"] == 1 and launch["attempt"]["retry_after_admission"] is False,
    "launch_ceiling": launch["aws"]["total_ceiling_usd"] == 10.0 and launch["aws"]["maximum_compute_usd"] <= 6.8796 and launch["aws"]["prior_attempt_estimate_usd"] + launch["aws"]["maximum_compute_usd"] < 10.0,
}
...
payload = {
    "schema": "lecore.qwen35-execution-summary.v6",
