...
from holographic_compose import (all_object_specs, compose_object, compose_scene,
                                  render_scene, roundtrip_object, roundtrip_scene,
                                  render_fidelity, novel_specs, animate_attribute,
                                  animation_is_faithful)
