...
import numpy as np
from holographic_ndfield import grid_graph, solve_grid_maze, sparse_reconstruct, _nadaraya_watson
...
def test_navigate_field_routes_around_cost():
    import numpy as np
    from holographic_ndfield import navigate_field, path_cost, straight_line_cells
...
def test_path_is_composable_hypervector():
    ...
    from holographic_ndfield import encode_path, decode_path_step
...
def test_navigate_raw_data_field():
    ...
    import numpy as np
    from holographic_ndfield import navigate_field, encode_path, decode_path_step
