...
from holographic_brdf import fresnel_schlick, fresnel_dielectric, cook_torrance
...
def test_metallic_f0_pinned():
    from holographic_brdf import metallic_f0
...
def test_f0_formula_has_one_home():
    ...
    import holographic_brdf, holographic_raymarch
