...
import numpy as np
from holographic_semantic import parse_description, render_scene, _scene_setup, _shade_rays
from holographic_rayindex import build_ray_index, delta_reshade
...
def test_brick_index_move_is_bit_exact_and_covers_changes():
    ...
    import numpy as np
    from holographic_rayindex import build_brick_index, delta_reshade_move
...
def test_brick_move_updates_through_glass_object():
    ...
    import numpy as np
    from holographic_rayindex import build_brick_index, delta_reshade_move, _object_aabb
    objs = parse_description("a glass ball beside a red ball")["objects"]
