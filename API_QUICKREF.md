...
*A scannable, one-line-per-symbol map of the app-building surface -- auto-generated by `apiquickref.py` on 2026-07-13. For the full engine (every module), see REFERENCE.md.*
