...
class Transform:
    ...
    def rotation(axis, angle):
        ...
        from holographic_transform import rotation_axis_angle
    ...
    def compose(*mats):
        ...
        from holographic_transform import compose
        return compose(*mats)
    ...
    def compose_trs(translate, quat, scale):
        ...
        from holographic_transform import compose_trs
    ...
    def steer_bandwidths(X, y, base=2.0, k=10, clip=8.0):
        ...
        from holographic_steering import steer_bandwidths
...
def _selftest():
    ...
    from holographic_transform import quat_from_axis_angle
    ...
    from holographic_ai import bind, unbind, permute
