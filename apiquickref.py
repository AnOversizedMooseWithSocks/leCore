...
def generate(root="."):
    ...
    out = ["# leCore API Quick Reference",
           "",
           # NO date/timestamp here on purpose: this file is drift-checked in CI (git diff --exit-code),
           # so any non-deterministic content makes it "stale" every day even when the API is unchanged.
