...
from holographic.caching_and_storage.holographic_word_index import build_semantic_index, SemanticIndex
...
def test_it_is_opt_in_import_does_not_load_dictionary():
    ...
    hd.unload()
    import importlib, holographic.caching_and_storage.holographic_word_index as holographic_word_index
