...
from holographic.agents_and_reasoning.holographic_valuehead import HolographicValueHead, _selftest
...
def test_discounted_return_is_a_geometric_bundle():
    from holographic.agents_and_reasoning.holographic_valuehead import discounted_return
...
def test_policy_atom_drives_decisions_in_vsa():
    from holographic.agents_and_reasoning.holographic_valuehead import decide_from_atom
