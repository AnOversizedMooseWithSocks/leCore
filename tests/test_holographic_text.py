...
from holographic.misc.holographic_text import TOPICS, MULTILINGUAL, learn_word_vectors, relatedness, LanguageID, TopicSorter, HolographicNGram, _split, _purity, _tokens
...
def test_self_organizing_memory_matches_simple_and_declines_to_oversplit():
    ...
    from holographic.misc.holographic_text import learn_word_vectors, _content, _split
...
def test_self_organizing_fires_and_helps_on_confusable_categories():
    ...
    from nltk.corpus import reuters
    from holographic.misc.holographic_text import _eval_classifiers
