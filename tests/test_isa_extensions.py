...
from holographic.agents_and_reasoning.holographic_ai import random_vector, bind, unbind, bundle, cosine
...
def test_base_kernel_stays_minimal_and_unchanged_by_extensions():
    ...
    import holographic.mesh_and_geometry.holographic_clifford as holographic_clifford, holographic.sampling_and_signal.holographic_fpe as holographic_fpe, holographic.sampling_and_signal.holographic_tensor as holographic_tensor# noqa: F401  (import the extensions)
