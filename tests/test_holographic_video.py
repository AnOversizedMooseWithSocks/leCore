...
from holographic.io_and_interop.holographic_video import HolographicVideo, estimate_shift
...
def test_subpixel_motion_beats_integer_search():
    ...
    from holographic.io_and_interop.holographic_video import estimate_subpixel_shift, fourier_shift, estimate_shift
    S = 64
    yy, xx = np.mgrid[0:S, 0:S].astype(float)
