...
from holographic.sampling_and_signal.holographic_fhrr import PhasorMemory, PhasorVocabulary, phasor_atom, fhrr_bind, fhrr_unbind, fhrr_sim
...
def test_phasor_cleanup_vectorized_matches_bruteforce():
    ...
    import numpy as np
    from holographic.sampling_and_signal.holographic_fhrr import PhasorVocabulary, fhrr_sim, phasor_atom
