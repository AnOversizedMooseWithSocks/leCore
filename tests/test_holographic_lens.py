...
import numpy as np
from holographic.rendering.holographic_lens import field_force, deflect, detect_caustic, navigate, _normalize
...
def test_field_force_points_toward_mass():
    ...
    from holographic.agents_and_reasoning.holographic_ai import exp_map
