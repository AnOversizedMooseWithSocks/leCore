...
from holographic.misc.holographic_determinism import fix_eigvec_signs, argmax_tiebreak, _selftest
...
def test_spectral_sign_fix_is_now_the_shared_rule_bit_exact():
    ...
    from holographic.sampling_and_signal.holographic_spectral import sign_fix
...
def test_chart_sign_fix_is_now_the_shared_rule_bit_exact():
    from holographic.misc.holographic_chart import _fix_signs
