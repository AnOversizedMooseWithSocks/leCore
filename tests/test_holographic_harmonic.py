...
from holographic.sampling_and_signal.holographic_harmonic import harmonic_atom, harmonic_decode, harmonic_dc
...
def test_online_rls_converges_to_batch_fit():
    from holographic.sampling_and_signal.holographic_harmonic import harmonic_atom, OnlineHarmonicAtom
