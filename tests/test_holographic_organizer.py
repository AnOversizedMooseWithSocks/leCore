...
from holographic.scene_and_pipeline.holographic_organizer import SelfOrganizingMind, SplitExpert, MergeExpert, SubPrototypeMemory, _multimodal_world
...
def test_self_trigger_fixes_cold_start_autonomously():
    from holographic.scene_and_pipeline.holographic_organizer import TriggerExpert
...
def test_fingering_prescreen_skips_only_when_safe_and_never_changes_the_choice():
    ...
    import copy
    from holographic.scene_and_pipeline.holographic_organizer import _multimodal_world
