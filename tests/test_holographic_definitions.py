...
from holographic.misc.holographic_definitions import build_standard_library, resolve_scenario, MATERIALS, GEOMETRY, rel_float, rel_sink, rel_rise, _density_class
from holographic.misc.holographic_core import unbind
...
def test_similarity_carries_physical_meaning(lib):
    ...
    from holographic.misc.holographic_core import cosine
...
def test_convolution_is_binding(lib):
    ...
    from holographic.misc.holographic_definitions import OPERATORS
