...
from holographic.agents_and_reasoning.holographic_ai import random_vector, bind, unbind, bundle, cosine, permute, Vocabulary, HolographicMemory, PartitionedMemory, HolographicLearner, geodesic, log_map, exp_map, slerp, ReflexArc, DriftDetector, recall_all
from holographic.io_and_interop.holographic_encoders import ScalarEncoder, TextEncoder, RecordEncoder
from holographic.agents_and_reasoning.holographic_reasoning import ResonatorNetwork, SemanticCompass, ConformalPredictor, EpistemicMap, vector_disagreement
from holographic.misc.holographic_extras import ResidueSystem, Region, ball, route, PredictiveFilter
from holographic.misc.holographic_field import Field, bump, landscape, seeded_landscape, ascend
from holographic.misc.holographic_diffusion import DoubleDiffusion
from holographic.caching_and_storage.holographic_sync import SyncGrouping
from holographic.scene_and_pipeline.holographic_orchestrator import Tool, ToolRegistry, SkeletonLibrary, Planner, CircuitBreaker, keyword_vector
...
def test_unitary_atoms_make_single_unbind_exact():
    ...
    import numpy as np
    from holographic.agents_and_reasoning.holographic_ai import unitary_vector, random_vector, bind, unbind, cosine
...
def test_unitary_widens_role_filler_cleanup_margin():
    ...
    import numpy as np
    from holographic.agents_and_reasoning.holographic_ai import unitary_vector, random_vector, bind, unbind, bundle, cosine
