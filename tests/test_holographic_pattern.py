...
import numpy as np
from holographic.misc.holographic_pattern import PATTERNS, make_pattern, value_noise, fbm, field_lerp
...
def test_pattern_resolves_through_param_socket():
    ...
    from holographic.misc.holographic_param import Param, resolve_param
