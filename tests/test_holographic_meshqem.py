...
from holographic.mesh_and_geometry.holographic_meshqem import vertex_quadrics, contraction_target, qem_decimate, surface_deviation, _edges
...
def test_surface_deviation_vectorized_matches_scalar_reference():
    ...
    from holographic.mesh_and_geometry.holographic_meshqem import surface_deviation, _point_to_triangle
...
def test_cluster_decimate_coarsens_is_parallel_and_deterministic():
    ...
    import numpy as np
    from holographic.mesh_and_geometry.holographic_meshbridge import sample_field, marching_tetrahedra_vec
    from holographic.mesh_and_geometry.holographic_meshqem import cluster_decimate, qem_decimate
...
def test_surface_deviation_fast_path_matches_brute_and_falls_back():
    ...
    import numpy as np
    from holographic.mesh_and_geometry.holographic_meshqem import surface_deviation, cluster_decimate
    from holographic.mesh_and_geometry.holographic_meshbridge import sample_field, marching_tetrahedra_vec
