...
def test_consolidate_projects_memory_at_behavioral_parity():
    ...
    import numpy as np
    from holographic.misc.holographic_creature import HolographicMind, CreatureEncoder, GridWorld, run_episode
    dim = 256
...
def test_describe_decodes_states_and_why_differ_explains():
    ...
    import numpy as np
    from holographic.misc.holographic_creature import HolographicMind, CreatureEncoder, GridWorld
...
def test_value_is_robust_to_a_raw_probe_on_a_consolidated_brain():
    ...
    import numpy as _np
    import holographic.misc.holographic_creature as hc
    import io
    import contextlib
