...
import numpy as np
from holographic.scene_and_pipeline.holographic_distribute import partition, adaptive_partition, distribute, distribute_scatter, reduce_sum, reduce_min, reduce_max, reduce_bundle
...
def test_distributed_vsa_memory_bundle_reassembly():
    ...
    from holographic.misc.holographic_core import random_vector, bind, unbind, cosine
...
def test_reduce_sum_exact_is_bit_exact_order_independent():
    ...
    from holographic.scene_and_pipeline.holographic_distribute import reduce_sum_exact, reduce_sum
...
def test_partition_2d_tiles_cover_disjointly():
    from holographic.scene_and_pipeline.holographic_distribute import partition_2d, distribute_bricks
    H, W = 40, 60
...
def test_partition_3d_bricks_bake_exact_and_order_independent():
    from holographic.scene_and_pipeline.holographic_distribute import partition_3d, distribute_bricks
