...
import numpy as np
import pytest
from holographic.materials_and_texture.holographic_texturegraph import Const, FieldLeaf, Map, field_leaf, sample_grid, encode, to_expr, NUMBER, COLOR, FIELD, MAP
...
def test_const_accepts_color_names():
    from holographic.simulation_and_physics.holographic_semantic import COLORS
    c = Const("red")
    assert c.kind == COLOR
