...
from holographic.mesh_and_geometry.holographic_topology import vr_simplices, betti_at_scale, persistent_topology, _gf2_rank, _boundary_columns, _make, _selftest
...
def test_gf2_betti_agrees_with_hodge_laplacian():
    ...
    from holographic.sampling_and_signal.holographic_spectral import betti_numbers as hodge_betti
...
def test_dense_cloud_is_capped_and_flagged():
    ...
    from holographic.mesh_and_geometry.holographic_topology import betti_at_scale, _subsample, _median_nn
