...
from holographic.misc.holographic_measure import measure, assert_robust, is_fragile, report
...
def test_resonator_factorization_is_robust():
    ...
    from holographic.misc.holographic_resonator import map_codebook, ResonatorNetwork, map_bind
