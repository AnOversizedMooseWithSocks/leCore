...
from holographic.materials_and_texture.holographic_matlib import material, RENDER_MATERIALS, by_class, biome_at, fractal_planet
...
def test_material_carries_physical_dielectric_and_fiber_properties():
    import holographic.materials_and_texture.holographic_matlib as L
...
def test_shade_adapter_routes_transmission_vs_opaque():
    import numpy as np, holographic.materials_and_texture.holographic_matlib as L
