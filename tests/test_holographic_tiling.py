...
from holographic.mesh_and_geometry.holographic_tiling import tile, tile_recursive, fractal_bands, grid_to_function, function_to_grid
...
def test_inception_volume_is_fractal_volume_levels_exactly():
    ...
    import numpy as np
    from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder
    from holographic.mesh_and_geometry.holographic_tiling import inception, fractal_volume
    enc = VectorFunctionEncoder(2, dim=8192, bounds=[(0, 200), (0, 200)], bandwidth=20.0, seed=0)
