...
from holographic.agents_and_reasoning.holographic_recurrent import EchoStateNetwork, VSAReservoir, ReservoirCharModel, ReservoirSequenceClassifier, bag_vs_reservoir, vsa_reservoir_step
...
def test_ngram_beats_reservoir_on_real_alice_generation():
    ...
    from holographic.agents_and_reasoning.holographic_recurrent import compare_to_ngram
