...
from holographic.agents_and_reasoning.holographic_ai import random_vector, unitary_vector, bind, unbind, bundle, permute, cosine, Vocabulary
...
def test_bind_batch_and_fixed_match_scalar_bind():
    ...
    from holographic.agents_and_reasoning.holographic_ai import bind, bind_batch, bind_fixed
    rng = np.random.default_rng(0)
...
def test_rfft_bind_recovers_under_unbind():
    ...
    from holographic.agents_and_reasoning.holographic_ai import bind, unbind, unitary_vector, random_vector, cosine
    rng = np.random.default_rng(1)
