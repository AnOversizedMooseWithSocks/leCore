...
import numpy as np
from holographic.misc.holographic_modulate import demodulate, remodulate, denoise_demodulated
...
def test_m5_carrier_from_downsampled_high_albedo():
    ...
    from holographic.misc.holographic_modulate import _downsample_to
