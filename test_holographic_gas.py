...
import numpy as np
from holographic_gas import (gas_density, speed_of_sound, adiabatic, boiling_point, IdealGas, specific_gas_constant)
...
def test_molar_mass_derived_from_composition():
    ...
    from holographic_gas import molar_mass_of, GAS_PROPERTIES
