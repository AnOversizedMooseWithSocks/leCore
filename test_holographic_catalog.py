...
from holographic_catalog import Catalog, Capability, default_catalog, seed_from_mind, _tokens
...
def test_every_engine_module_has_a_docstring():
    ...
    import ast, glob, os
    import holographic_catalog
    root = os.path.dirname(os.path.abspath(holographic_catalog.__file__))
    missing = []
