...
class Scale:
    ...
    @staticmethod
    def _reducer(reduce):
        from holographic.scene_and_pipeline.holographic_distribute import reduce_sum, reduce_min, reduce_max, reduce_bundle, reduce_sum_exact
    ...
    def partition(n, k, costs=None):
        ...
        from holographic.scene_and_pipeline.holographic_distribute import partition, adaptive_partition
    ...
    def tiles(shape, blocks):
        ...
        from holographic.scene_and_pipeline.holographic_distribute import partition_2d, partition_3d
    ...
    def bricks(out_shape, regions, worker, cache=None, fill=0.0, skip=None):
        ...
        from holographic.scene_and_pipeline.holographic_distribute import distribute_bricks
