...
def _reflect_of(obj):
    ...
    from holographic.simulation_and_physics.holographic_semantic import MATERIAL_RENDER
...
def render_adaptive(objects, camera, width=256, height=256, frames=1, relight=False, light=None,
    ...
    if plan["path"] == "dispatch":
        from holographic.simulation_and_physics.holographic_semantic import realize_scene, _scene_setup
