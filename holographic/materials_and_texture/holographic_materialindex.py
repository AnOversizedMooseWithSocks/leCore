...
"""
import holographic.materials_and_texture.holographic_matlib as _render
from holographic.misc.holographic_definitions import MATERIALS as _physical
...
def physical_units():
    ...
    from holographic.materials_and_texture.holographic_materialdata import UNITS
    return dict(UNITS)
...
def validate_physical():
    ...
    from holographic.materials_and_texture.holographic_materialdata import validate
    return validate()
