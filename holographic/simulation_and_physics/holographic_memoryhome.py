...
class Memory:
    ...
    def bind_cached(a, b, cache):
        ...
        from holographic.caching_and_storage.holographic_residency import bind_cached
    ...
    def unbind_cached(composite, a, cache):
        ...
        from holographic.caching_and_storage.holographic_residency import unbind_cached
    ...
    def tiles(shape, blocks):
        ...
        from holographic.misc.holographic_scalehome import Scale
    ...
    def backend(kind="numpy"):
        ...
        from holographic.misc.holographic_backend import enable_gpu, gpu_enabled
        if kind == "gpu":
            enable_gpu(True)
        elif kind == "numpy":
            enable_gpu(False)
