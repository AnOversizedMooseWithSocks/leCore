...
class StableFluid:
    ...
    def __init__(self, shape, dt=0.1, viscosity=0.0, diffusion=0.0,
        ...
        from holographic.misc.holographic_backend import array_module
        self.device = device
    ...
    def step(self):
        ...
        if self.power_law_n != 1.0 and self.d == 2:
            ...
            from holographic.simulation_and_physics.holographic_nonnewtonian import viscous_step
            from holographic.misc.holographic_backend import asnumpy
