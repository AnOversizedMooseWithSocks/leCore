...
from holographic.rendering.holographic_denoise import project_onto_constraints   # reuse the shipped iterate-a-projection sweeper
...
class SoftBody:
    ...
    def _solve_collisions(self):
        ...
        from holographic.misc.holographic_fields import spatial_hash_pairs            # the reusable cull primitive
