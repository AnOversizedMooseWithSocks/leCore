...
# THE REPO ROOT IS TWO LEVELS UP NOW. This was `dirname(__file__)` when the
# module sat beside setup.py, and moving it into the package silently
# redirected every output into holographic/caching_and_storage/ -- the file was
# regenerated, the test still failed, and the stale copy at the root looked
# like a generator bug. A PATH RELATIVE TO __file__ IS A PATH THAT MOVES WITH
# THE FILE, which is the whole hazard of relocating a generator.
