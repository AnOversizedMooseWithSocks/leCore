...
# The bare-name ALIAS MAP lives in its own data module (sweep 124): it is a table that grows
# by design -- every discoverability sweep adds stranger phrasings -- and it pushed this file over
# the 2,000-line giant budget. The duplicate-key audit globs holographic_catalog*.py, so the table
# stays under its watch. Same object, same name, imported here.
from holographic.caching_and_storage.holographic_catalog_aliases import _METHOD_ALIASES  # noqa: E402
