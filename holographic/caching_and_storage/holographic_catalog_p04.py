...
def register_p04(c):
    ...
    c.register_capability("Dialect emitters (WGSL / C / JS / Zig from the Python kernel)", "leCore's kernels are written "
                          ...
                          "MEASURED on the sphere SDF, smoothstep and cosine over 200 random inputs: c_f64 stays "
                          "within one ULP of the Python original (operation order fixed; platform libm can round "
                          "an intrinsic differently); c_f32 "
