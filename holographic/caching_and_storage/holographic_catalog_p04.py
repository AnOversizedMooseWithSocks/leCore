...
def register_p04(c):
    ...
    c.register_capability(
        ...
        "the PRODUCT-FACING wedge: LocalAgentCore gives a local agent deterministic text memory "
        "(remember/recall), skill routing over the live capability catalog, JSON persistence, and "
        "a readiness dashboard with C-kernel status. This is the small stable door for embedding "
        "leCore without learning the whole research surface first.",
        ...
        native=True,
        aliases=("product", "productization", "agent memory", "local memory", "durable memory", "recall",
