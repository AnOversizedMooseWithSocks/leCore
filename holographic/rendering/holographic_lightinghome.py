...
`Lighting` is the one door. It RE-EXPORTS the light types (so `from holographic.rendering.holographic_lightinghome import Lighting,
...
from holographic.rendering.holographic_lights import PointLight, DirectionalLight, AmbientLight, SpotLight, RectLight, DiskLight, SphereLight, DomeLight, MeshLight, IESLight, direct_lighting
...
class Lighting:
    ...
    def prt(transfer, light_sh, albedo=None):
        ...
        from holographic.misc.holographic_prt import shade_prt
    ...
    def environment_sh(dome, order=3, n=1024):
        ...
        from holographic.caching_and_storage.holographic_domecache import dome_light_sh
...
def _selftest():
    ...
    from holographic.misc.holographic_prt import precompute_transfer, project_env_to_sh
