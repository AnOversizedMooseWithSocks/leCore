...
def delta_reshade(ctx_new, index, changed_ids, base_frame, camera):
    ...
    from holographic.simulation_and_physics.holographic_semantic import _shade_rays
...
def _selftest():
    ...
    from holographic.simulation_and_physics.holographic_semantic import parse_description, render_scene, _scene_setup
