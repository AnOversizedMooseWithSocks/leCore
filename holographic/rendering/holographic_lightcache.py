...
from holographic.caching_and_storage.holographic_domecache import cached_screen_shade, _primary_gbuffer
from holographic.rendering.holographic_lightinghome import Lighting          # the Lighting home  consolidation R7
...
from holographic.rendering.holographic_lights import RectLight, DiskLight, SphereLight, MeshLight
...
def cached_indirect_shade(sdf, camera, width, height, lights, material_fn, n_dirs=48, seed=0, stride=8,
    ...
    from holographic.sampling_and_signal.holographic_samplinghome import Sampling                        # cosine-hemisphere from the Sampling home  R4
