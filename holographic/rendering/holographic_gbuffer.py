...
def converge_samples(scene, camera, width, height, material, sky=None, quality="high",
    ...
    from holographic.sampling_and_signal.holographic_adaptive_sample import converged_mask, ci_half_width
...
def aces_tonemap(hdr, exposure=1.0, auto=True, key=0.18):
    ...
    from holographic.rendering.holographic_postfx import aces, gamma, auto_exposure
