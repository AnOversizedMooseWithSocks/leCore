...
from holographic_ai import (bind, bundle, unbind, cosine, involution, involution_batch,
                            unbind_all, bundle_bind, nearest)
...
def test_classifier_encode_runs_through_bundle_bind():
    from holographic_ai import HolographicLearner
