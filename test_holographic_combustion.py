...
import numpy as np
from holographic_combustion import (COMBUSTION, ignites, flame_color, combustion_products, Fire,
                                    configure_fluid, emit_smoke)
...
def test_flame_tint_from_element_composition():
    ...
    import numpy as np
    from holographic_combustion import flame_color
