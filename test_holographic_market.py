...
from holographic_market import CandleCoder, load_ohlcv
...
def test_sequentiality_responds_to_regime():
    ...
    from holographic_sequence import sequentiality_z
    from holographic_ai import Vocabulary
    from holographic_market import load_ticks
...
def test_ray_targets_beat_unconditional_on_held_out_half():
    ...
    import numpy as np
    from holographic_market import load_ticks, move_series, RayProjector
...
def test_big_dai_structure_holds_at_scale():
    ...
    import json
    import numpy as np
    from holographic_market import CandleCoder
    from holographic_sequence import sequentiality_z
    from holographic_ai import Vocabulary
