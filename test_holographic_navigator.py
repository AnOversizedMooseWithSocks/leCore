...
from holographic_navigator import (DataWorld, CreatureEncoder, HolographicMind,
                                    train, evaluate, fixed_beam_curve)
...
def test_reflex_habits_help_on_skew_and_dont_hurt_on_uniform():
    from holographic_navigator import Navigator, _zipf_workload
    world, enc, mind = _trained_world(seed=0)
    items = world.items
