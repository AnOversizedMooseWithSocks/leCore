...
"""
import numpy as np
from holographic_query import UserTable, run_db_sql, Database, QueryError
...
def _selftest():
    ...
    from holographic_query import update as _update
    ...
    bt = b.checkout(-1)
    from holographic_query import update as _u2
