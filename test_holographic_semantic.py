...
from holographic_semantic import (parse_description, encode_objects, encode_scene, decode_object,
                                   query_scene, batch_set, find_objects, control_spec, realize_scene,
                                   schema_codebooks, render_scene)
...
def test_single_pass_render_sees_through_glass():
    ...
    import numpy as np
    import holographic_semantic as HS
    from holographic_semantic import render_scene, _SphereSDF, _BoxSDF, COLORS, MATERIAL_RENDER
...
def test_supersampling_reduces_aliasing():
    ...
    import numpy as np
    from holographic_render import Camera
    from holographic_postfx import _fft_blur
...
def test_incremental_rerender_only_touches_changed_object():
    ...
    import numpy as np
    from holographic_render import Camera
    from holographic_semantic import SceneRenderer
...
def test_pbr_materials_resolve():
    from holographic_semantic import _pbr_props
...
def test_path_traced_render_runs():
    import numpy as np
    from holographic_render import Camera
    from holographic_semantic import parse_description, render_scene_pbr
...
def test_volumetric_materials_parse_and_render():
    import numpy as np
    from holographic_render import Camera
    from holographic_semantic import parse_description, render_scene, _VOLUMETRIC
