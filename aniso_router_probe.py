...
from multidim_shadow_probe import (visibility, ground_truth, box_sample,
                                    FLOOR_EXTENT, LIGHT_HALF)
from holographic_vision import gradient as vision_gradient          # edge magnitude map for the router (reuse)
