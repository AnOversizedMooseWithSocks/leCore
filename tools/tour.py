...
from holographic.agents_and_reasoning.holographic_ai import Vocabulary, HolographicMemory, bind, unbind, bundle, cosine, random_vector
from holographic.io_and_interop.holographic_encoders import ScalarEncoder, TextEncoder, RecordEncoder, _CORPUS
from holographic.agents_and_reasoning.holographic_reasoning import ResonatorNetwork
from holographic.misc.holographic_creature import GridWorld, CreatureEncoder, HolographicMind, _baseline, _train, _evaluate
import importlib
...
from holographic.scene_and_pipeline.holographic_scene import SceneCoder as _SC
...
from holographic.misc.holographic_creature import GridWorld as _GW, WorldView as _WV
...
from holographic.misc.holographic_market import CandleCoder as _CC, load_ohlcv as _load
_a = _load(); _cc = _CC()
...
import numpy as _np
from holographic.misc.holographic_market import load_ticks as _lt
_ts, _px = _lt()
...
from holographic.misc.holographic_market import RayProjector as _RP, move_series as _ms
_mv, _mb = _ms(_ts, _px)
...
from holographic.simulation_and_physics.holographic_physics import Kinematics as _Kin
_k = _Kin()
...
from holographic.misc.holographic_market import CandleCoder as _CCb
...
try:
    from holographic.misc.holographic_market import load_sol_market as _lsm, load_onchain_traders as _lot
    ...
    import tools.unified_app as _ua
...
from holographic.io_and_interop.holographic_video import HolographicVideo as _HV
...
from holographic.io_and_interop.holographic_video import estimate_subpixel_shift as _ess, fourier_shift as _fs, estimate_shift as _es
_S=64; _yy,_xx=np.mgrid[0:_S,0:_S].astype(float)
...
from holographic.caching_and_storage.holographic_history import VersionedStore as _VS
...
from holographic.agents_and_reasoning.holographic_lexicon import Lexicon as _Lex
...
from holographic.agents_and_reasoning.holographic_encyclopedia import Encyclopedia as _Enc
...
from holographic.misc.holographic_unified import UnifiedMind as _UM
...
if _os.path.isdir("features/photo_sample") and _glob.glob("features/photo_sample/*.npy"):
    from holographic.rendering.holographic_photos import load_photo_folder as _lpf, robustness_curve as _rc
...
from holographic.misc.holographic_resolution import coarse_to_fine as _c2f, full_scan as _fs
import numpy as _np
...
from holographic.misc.holographic_fractal import IFS as _IFS, ifs_compresses as _ifsc, image_fractal_dimension as _ifd
...
from holographic.misc.holographic_generation import ContextGenerator as _CG
...
from holographic.agents_and_reasoning.holographic_fountain import Fountain as _F, recovery_curve as _rc
...
from holographic.agents_and_reasoning.holographic_predictive import PredictiveMemory as _PM
...
from holographic.agents_and_reasoning.holographic_meaning_predict import MeaningPredictor as _MP
...
from holographic.misc.holographic_structure import StructureVerifier as _SV, steered_generate as _sg
from holographic.agents_and_reasoning.holographic_meaning_predict import MeaningPredictor as _MP2, cooccurrence_space as _cs
...
from holographic.agents_and_reasoning.holographic_respond import respond as _rsp, query_target as _qt, relevance as _rl
...
from holographic.agents_and_reasoning.holographic_deliberate import Deliberator as _Del
_del=_Del(_mp4,_v)
...
from holographic.misc.holographic_signal_structure import SignalStructureVerifier as _SSV, clustering_zscore as _cz
...
from holographic.misc.holographic_compress import PredictiveCompressor as _PC
_pc=_PC(_mp4)
...
from holographic.misc.holographic_segment import Segmenter as _Seg, boundary_f1 as _bf1, chunk_compression as _cc
...
from holographic.misc.holographic_resonator import ResonatorNetwork as _RN, map_codebook as _mc, map_bind as _mb
...
from holographic.misc.holographic_codec import PredictiveCodec as _Cod
_cod=_mp4 and _Cod(_mp4)
_real8=_st2[:120]
_ok=_cod.roundtrip_ok(_real8); _cst=_cod.cost(_real8)
_per8=["alpha","beta","gamma","delta"]*30
_vp,_Mp,_ip=importlib.import_module("holographic.agents_and_reasoning.holographic_meaning_predict").cooccurrence_space([_per8],dim=512,window=2,seed=0)
_mpp=importlib.import_module("holographic.agents_and_reasoning.holographic_meaning_predict").MeaningPredictor(dim=512,order=2,seed=0).set_space(_vp,_Mp).fit_transitions(_per8)
...
if _os.path.isdir("features/sprites"):
    import tools.pack_sprites as _ps, io as _io
...
try:
    ...
    from holographic.misc.holographic_signal_structure import volatility_clustering as _vc, clustering_zscore as _cz
    from holographic.misc.holographic_market import load_ticks as _lt, move_series as _ms
...
from holographic.misc.holographic_creature import HolographicMind as _HM
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_recurrent import ReservoirSequenceClassifier as _RSC
...
try:
    import re as _reV
    from holographic.misc.holographic_measure import measure as _measure, report as _vreport
    from holographic.misc.holographic_text import HolographicNGram as _HN
...
try:
    from holographic.misc.holographic_ablate import key_value_noisy as _kvn, recall_index as _ri, verdict as _vd
    ...
    from holographic.misc.holographic_ablate import ablation_table as _at, fdr_verdicts as _fdr
...
# for sonification).
try:
    from holographic.misc.holographic_generate import morph_images as _mi, crossfade_images as _cf, ghosting as _gh, sequence_to_pitches as _s2p
    from holographic.misc.holographic_archive import HolographicArchive as _HA, _gallery as _gal
    _imgs = _gal(S=64)
...
try:
    ...
    import holographic.misc.holographic_core as _core
    from holographic.misc.holographic_creature import HolographicMind as _HM
...
try:
    ...
    import holographic.scene_and_pipeline.holographic_scene as _hsF
    from holographic.misc.holographic_compose import novel_specs as _ns, roundtrip_object as _rto, roundtrip_scene as _rts, render_fidelity as _rf, animate_attribute as _aa, animation_is_faithful as _aif
...
try:
    from holographic.misc.holographic_unified import UnifiedMind as _UMn
    import holographic.scene_and_pipeline.holographic_scene as _hsn
...
try:
    from holographic.misc.holographic_unified import UnifiedMind as _UMf
    from holographic.agents_and_reasoning.holographic_ai import random_vector as _rvf, bind as _bf, unbind as _ubf, cosine as _cf
...
try:
    import holographic.misc.holographic_core as _coreQ
    from holographic.scene_and_pipeline.holographic_organizer import SelfOrganizingMind as _SOMq, _multimodal_world as _mmw
...
try:
    import numpy as _npR
    from holographic.agents_and_reasoning.holographic_ai import random_vector as _rvR, bundle as _buR, cosine as _coR
    from holographic.misc.holographic_ratedistortion import geometry_preserving_code as _gpc, reconstruct as _rec, bits_per_vector as _bpv
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_kan import HolographicKAN as _HK
...
try:
    import numpy as _npR
    from holographic.misc.holographic_recipe import StructureRecipe as _SR
    from holographic.agents_and_reasoning.holographic_ai import derived_atom as _da
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_symbolic import symbolic_regress as _sr, full_fit as _ff
    ...
    from holographic.agents_and_reasoning.holographic_symbolic import compress_signal as _cs
    ...
    from holographic.agents_and_reasoning.holographic_symbolic import symbolic_regress as _sreg
...
try:
    from holographic.misc.holographic_sbc import sbc_codebook as _scb, sbc_reconstruct as _srec, sbc_resonator as _sres
    _B, _L = 16, 16
    ...
    from holographic.misc.holographic_sbc import decompose_structure as _dstr, sbc_identity as _sid
    _cbi = [list(_scb(_B, _L, 8, seed=20 + _k)) + [_sid(_B)] for _k in range(3)]
    _fac = [_cbi[0][3], _cbi[1][6], _sid(_B)]; _Pp = _fac[0].copy()
    for _f in (1, 2): _Pp = importlib.import_module("holographic.misc.holographic_sbc").sbc_bind(_Pp, _fac[_f], _L)
...
try:
    from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HM
    from holographic.misc.holographic_typed import program_to_recipe as _p2r, encode_tree as _etr, tree_to_recipe as _t2r, nested_scene_to_recipe as _n2r, op_kinds as _opk
    from holographic.agents_and_reasoning.holographic_ai import cosine as _cosK
    ...
    _mnK = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=1024, seed=3)
...
try:
    from holographic.rendering.holographic_peel import chain_recipe as _crc, traversal_score as _tsc, recover_continuous_values as _rcv
    from holographic.io_and_interop.holographic_encoders import ScalarEncoder as _SE
    ...
    from holographic.agents_and_reasoning.holographic_ai import bind as _bB, derived_atom as _daB
...
try:
    ...
    from holographic.mesh_and_geometry.holographic_manifold import decompose_on_manifold as _dom, detect_topology as _dt
    from holographic.agents_and_reasoning.holographic_symbolic import symbolic_regress as _srB9
    from holographic.mesh_and_geometry.holographic_manifold import line_dictionary as _lineD
...
try:
    ...
    from holographic.misc.holographic_creature import GridWorld as _GWB6
    from holographic.misc.holographic_flow import solve_maze_flow as _smf
...
try:
    from holographic.simulation_and_physics.holographic_assembly import assemble as _asm, assemble_optimal_energy as _asmopt
...
try:
    ...
    from holographic.rendering.holographic_denoise import fit_manifold as _fmA, manifold_denoise as _mdA, fit_manifold_full as _fmf, adaptive_manifold_denoise as _amd
...
try:
    ...
    from holographic.misc.holographic_unified import UnifiedMind as _UMTR
...
try:
    ...
    from holographic.misc.holographic_unified import UnifiedMind as _UMGS
...
try:
    ...
    from holographic.misc.holographic_unified import UnifiedMind as _UMMC
    from holographic.misc.holographic_chart import geodesic_distances as _geoMC
...
try:
    ...
    from holographic.misc.holographic_determinism import fix_eigvec_signs as _fesDC
    from holographic.sampling_and_signal.holographic_spectral import sign_fix as _sfDC
    from holographic.misc.holographic_chart import _fix_signs as _cfDC
...
try:
    from holographic.misc.holographic_unified import UnifiedMind as _UMCF
    from holographic.misc.holographic_reference import value_conformant as _vcCF, decision_conformant as _dcCF
...
try:
    ...
    from holographic.mesh_and_geometry.holographic_clifford import CliffordAlgebra as _CAEX
    from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFEX
    from holographic.sampling_and_signal.holographic_tensor import TensorBindMemory as _TBEX
    from holographic.agents_and_reasoning.holographic_ai import random_vector as _rvEX, bind as _bEX, unbind as _ubEX, bundle as _blEX, cosine as _csEX
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HMRG
    from holographic.agents_and_reasoning.holographic_ai import cosine as _csRG, random_vector as _rvRG, bind as _bRG, unbind as _ubRG, bundle as _blRG
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HMCS, stack_push as _spCS, stack_pop as _ppCS
    from holographic.agents_and_reasoning.holographic_ai import cosine as _csCS, random_vector as _rvCS
...
try:
    ...
    from holographic.simulation_and_physics.holographic_template import STARTER_LIBRARY as _LIB
    from holographic.agents_and_reasoning.holographic_ai import unbind as _ubTP, cosine as _csTP, derived_atom as _daTP
    _rec = _LIB["record"]
...
try:
    ...
    from holographic.misc.holographic_lang import realize_spec as _rsLG, compile_spec as _csLG, parse as _pLG, unparse as _uLG
    from holographic.simulation_and_physics.holographic_template import STARTER_LIBRARY as _LIBLG
...
try:
    ...
    from holographic.misc.holographic_reversible import reversibility_audit as _audRV, auto_cleanup_run as _acrRV, _bursty_program as _bpRV
    from holographic.agents_and_reasoning.holographic_ai import random_vector as _rvRV, cosine as _csRV
...
try:
    ...
    from holographic.misc.holographic_steering import steer_bandwidths as _sbST, kernel_regress as _krST
    from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFST
...
try:
    ...
    from holographic.misc.holographic_iterate import step_k as _skIT, spectral_profile as _spIT
    from holographic.simulation_and_physics.holographic_dynamics import Propagator as _PrIT
...
try:
    ...
    from holographic.agents_and_reasoning.holographic_ai import bind as _bd, bind_fixed as _bfx, random_vector as _rvU
    ...
    from holographic.io_and_interop.holographic_encoders import ScalarEncoder as _SE
    from holographic.agents_and_reasoning.holographic_ai import cosine as _cosU
    ...
    from holographic.misc.holographic_tree import HoloForest as _HF
    ...
    from holographic.agents_and_reasoning.holographic_honesty import walk_forward_recall as _wfr, bh_fdr as _bh
    _N = 1200
    ...
    from holographic.agents_and_reasoning.holographic_honesty import RecallNull as _RN
    from holographic.agents_and_reasoning.holographic_ai import Vocabulary as _Vc, random_vector as _rvv
    _voc = _Vc(512, seed=1)
    ...
    from holographic.agents_and_reasoning.holographic_honesty import SPRTRecall as _SPRT
    _nullsc = _cal.null
...
try:
    from holographic.agents_and_reasoning.holographic_hopfield import dense_cleanup as _dc, generate as _gen
    from holographic.rendering.holographic_denoise import fit_manifold as _fm, manifold_denoise as _md
    from holographic.rendering.holographic_splat import splat_fit as _sf, splat_render as _sr, psnr as _ps
    from holographic.agents_and_reasoning.holographic_ai import Vocabulary as _Vh, random_vector as _rvh
    ...
    from holographic.rendering.holographic_denoise import nlm_denoise as _nlm, fit_manifold as _fm2, manifold_denoise as _md2
    ...
    from holographic.simulation_and_physics.holographic_dynamics import Propagator as _Pr
    from holographic.agents_and_reasoning.holographic_ai import bind as _bd, cosine as _cos, random_vector as _rvp
...
try:
    from holographic.mesh_and_geometry.holographic_mobius import AxialEncoder as _Ax, antiperiodic_fraction as _afr
...
try:
    from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HM
    from holographic.agents_and_reasoning.holographic_ai import bind as _bM, bundle as _buM, cosine as _coM
    ...
    from holographic.agents_and_reasoning.holographic_ai import permute as _pm
...
try:
    import tools.unified_app as _uaT
...
import holographic.misc.holographic_tree as ht
...
from holographic.misc.holographic_text import TOPICS, _content
...
import numpy as _np
from holographic.agents_and_reasoning.holographic_machine import cosine as _cos
...
um.index_procedures()
from holographic.agents_and_reasoning.holographic_machine import derived_atom as _datom
...
from holographic.agents_and_reasoning.holographic_machine import bind as _bind
...
from holographic.agents_and_reasoning.holographic_machine import permute as _perm
...
from holographic.misc.holographic_sbc import sbc_codebook as _scb2, sbc_reconstruct as _srec2
...
from holographic.mesh_and_geometry.holographic_planshape import PlanNode as _PN
...
from holographic.agents_and_reasoning.holographic_ai import Vocabulary as _Vc, random_vector as _rv
_v = _Vc(512, seed=2)
...
from holographic.misc.holographic_creature import GridWorld as _GW
...
from holographic.rendering.holographic_splat import psnr as _psnr
...
from holographic.rendering.holographic_splat import splat_bundle as _sb, recall_region as _rr
_ssp = _sf(_T, 30)
...
from holographic.sampling_and_signal.holographic_lowdiscrepancy import dispersion as _ldisp
...
from holographic.misc.holographic_traverse import gated_traverse as _gtrav
from holographic.agents_and_reasoning.holographic_ai import bind as _tbind, involution as _tinvf
...
from holographic.rendering.holographic_sharpen import _gauss_blur as _sgb
_st = np.arange(256)
...
from holographic.misc.holographic_twolayer import _fft_topk as _f2, _sparse_topk as _s2
_c2t = np.arange(256)
...
from holographic.sampling_and_signal.holographic_fhrr import phasor_atom as _pmatom, fhrr_sim as _pmsim
from holographic.simulation_and_physics.holographic_phasemorph import amplitude_morph as _pmamorph
...
from holographic.misc.holographic_sbc import sbc_codebook as _a2cb, sbc_reconstruct as _a2rec
...
from holographic.misc.holographic_backwardwarp import forward_scatter as _bwfs, backward_gather as _bwbg
...
from holographic.misc.holographic_reanchor import directed_linked_list as _r2ll, make_steps as _r2steps
...
from holographic.agents_and_reasoning.holographic_honesty import SPRTRecall as _SP
...
import holographic.misc.holographic_sbc as _S
...
from holographic.agents_and_reasoning.holographic_ai import unbind as _unbind, cosine as _cos
_gnbr = {}
for _r in range(7):
    for _c in range(7):
...
from holographic.agents_and_reasoning.holographic_ai import bind as _bnd, unbind as _unb, derived_atom as _da, cosine as _csn
...
from holographic.rendering.holographic_splat import psnr as _psp
...
from holographic.agents_and_reasoning.holographic_ai import bind as _tbnd, unbind as _tunb, random_vector as _trv, cosine as _tcos
...
import holographic.misc.holographic_rns as _rns
...
import holographic.misc.holographic_compute as _hc
...
import holographic.agents_and_reasoning.holographic_ai as _hai
...
from holographic.misc.holographic_archive import HolographicArchive as _HA
...
from holographic.simulation_and_physics.holographic_equilibrium import _moons as _mk
...
from holographic.misc.holographic_forward import _blobs as _bl
...
from holographic.misc.holographic_chaos import lorenz_trajectory as _lz
...
from holographic.simulation_and_physics.holographic_energy import torus_bump_manifold as _tbm
from holographic.agents_and_reasoning.holographic_hopfield import dense_cleanup as _dc
...
from holographic.agents_and_reasoning.holographic_hopfield import dense_cleanup as _dc
from holographic.agents_and_reasoning.holographic_ai import cosine as _csg
...
from holographic.agents_and_reasoning.holographic_ai import unitary_vector as _uv, random_vector as _rv, bind as _bd, unbind as _ub
from holographic.agents_and_reasoning.holographic_hopfield import generate_structure as _gst, _unit_rows as _ur
...
from holographic.misc.holographic_sbc import sbc_reconstruct as _recon
...
from holographic.agents_and_reasoning.holographic_reasoning import ResonatorNetwork as _RN
...
from holographic.sampling_and_signal.holographic_dedoppler import dedoppler_bank as _ddb
...
from holographic.agents_and_reasoning.holographic_ai import bind as _vbind, cosine as _vcos
_vm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=512, seed=0)
...
from holographic.agents_and_reasoning.holographic_ai import bind as _fpbind, cosine as _fpcos
_fpm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=512, seed=0)
from holographic.io_and_interop.holographic_encoders import ScalarEncoder as _FPSE                # 1-D FPE was already the ScalarEncoder
...
_spm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
from holographic.sampling_and_signal.holographic_spectral import cycle_laplacian as _spcyc, laplacian_eigenbasis as _speig, betti_numbers as _spbetti
...
_tpm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_mgm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
from holographic.sampling_and_signal.holographic_spectral import knn_laplacian as _mgkl, laplacian_eigenbasis as _mgle
...
from holographic.sampling_and_signal.holographic_spectral import boundary_matrices as _hgbm
_hgm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_clm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
_clcl = _clm.clifford()
...
_wsm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_fcm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
def _fcgrid(R, C):
    nbr = {}
    for r in range(R):
        for c in range(C):
...
_sdm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_shm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=512, seed=7)
_shD = _shm.dim
...
_aum = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_kbm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
_kb.save(_kb_path)
_kb_reloaded = importlib.import_module("holographic.agents_and_reasoning.holographic_knowledge").FindingRegistry.load(_kb_path)
...
_svgm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=4096, seed=0)
...
from holographic.agents_and_reasoning.holographic_creature_mind import CreatureMind as _CM
...
_meshm = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
...
from holographic.mesh_and_geometry.holographic_mesh import Mesh as _MeshFwd7
from collections import Counter as _CounterFwd7
from holographic.misc.holographic_eulerops import _face_with_directed_edge as _fwde, _third as _thirdv
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _icos, laplacian_smooth as _lapsm
...
from holographic.mesh_and_geometry.holographic_meshcurvature import gauss_bonnet_defect as _gbdef, gaussian_curvature as _gcurv, mean_curvature as _hcurv
...
from holographic.mesh_and_geometry.holographic_meshuv import flat_grid_mesh as _flat_grid, hemisphere_cap as _hemicap
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _ico_verbs
from holographic.mesh_and_geometry.holographic_meshverbs import _face_normal as _fn_verbs
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _ico_sd
from holographic.mesh_and_geometry.holographic_meshuv import flat_grid_mesh as _flat_sd
from holographic.mesh_and_geometry.holographic_meshcurvature import dihedral_angles as _dih_sd
from holographic.mesh_and_geometry.holographic_meshsubdiv import _triangles as _tri_sd
from holographic.mesh_and_geometry.holographic_mesh import box as _box_sd, Mesh as _Mesh_sd
_s_sd = _ico_sd(1)
...
from holographic.mesh_and_geometry.holographic_meshik import chain as _chain_ik
...
from holographic.mesh_and_geometry.holographic_meshskin import linear_blend_skin as _lbs, make_transform as _mt, rotation as _rot
...
from holographic.mesh_and_geometry.holographic_meshbridge import sphere_sdf as _sphere_sdf, metaball_field as _metaball
...
_bad_r = importlib.import_module("holographic.misc.holographic_recipeops")._clone(_ra); _bad_r._ops[3] = ("bind", 3, 99)
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _ico_seam
from holographic.mesh_and_geometry.holographic_meshuv import uv_unwrap as _uvu_seam, uv_distortion as _uvd_seam, puncture as _punc_seam
_ssph = _ico_seam(3)
...
from holographic.mesh_and_geometry.holographic_mesh import Mesh as _Mesh_csg
...
from holographic.misc.holographic_simgraph import _ring_vectors as _ringv, _circ_corr as _ccorr
...
from holographic.mesh_and_geometry.holographic_mesh import box as _box_v2
_cube_v2 = _box_v2()
...
from holographic.misc.holographic_recipeops import validate as _validate_sg
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _icosphere_qem
...
from holographic.misc.holographic_eulerops import collapse_edge as _ce_qem
from holographic.mesh_and_geometry.holographic_meshqem import _edges as _edges_qem
_m_qem = _ico_qem
...
from holographic.mesh_and_geometry.holographic_meshsmooth import _icosphere as _icos_lod
...
from holographic.agents_and_reasoning.holographic_ai import unitary_vector as _uvec_bs, random_vector as _rvec_bs
...
from holographic.rendering.holographic_splat import splat_fit as _sfit_lod, splat_render as _srend_lod, splat_refit as _sref_lod, psnr as _psnr_lod
...
from holographic.scene_and_pipeline.holographic_scenegraph import SceneNode as _SN_sd, translation as _tr_sd
from holographic.mesh_and_geometry.holographic_mesh import box as _box_sd
from holographic.scene_and_pipeline.holographic_scenedelta import scene_components as _scomp_sd, apply_scene_delta as _apply_sd
...
from holographic.rendering.holographic_splat import splat_render as _sr_cs, splat_refit as _rf_cs
from holographic.rendering.holographic_splatdensify import clone_splat as _cl_cs, split_splat as _sp_cs
...
from holographic.misc.holographic_relocate import birth_death_relocate as _bdr
...
from holographic.io_and_interop.holographic_video import HolographicVideo as _HV4
...
from holographic.mesh_and_geometry.holographic_meshbridge import metaball_field as _mbf4, sample_field as _sf4, marching_tetrahedra as _mt4
...
from holographic.rendering.holographic_splatexport import splats_from_ply as _sfp3, quaternion_to_rotation as _q2r3
...
from holographic.mesh_and_geometry.holographic_meshbridge import sample_field as _sf_fwd, marching_tetrahedra as _mt_py, marching_tetrahedra_vec as _mt_vec
...
from holographic.mesh_and_geometry.holographic_meshqem import surface_deviation as _sd_fwd
...
from holographic.mesh_and_geometry.holographic_meshbridge import _closest_point_on_triangle as _cpt1, _closest_points_on_triangles as _cptN, point_set_to_mesh as _p2m
...
from holographic.mesh_and_geometry.holographic_meshbridge import mesh_to_sdf_grid as _m2sdf, marching_tetrahedra_vec as _mtv2
...
from holographic.mesh_and_geometry.holographic_meshbridge import point_set_to_mesh_grid as _p2mg
...
from holographic.misc.holographic_sparsefield import SparseField as _SF, _smooth_falloff as _sfall
...
from holographic.sampling_and_signal.holographic_noise import FractalNoise as _FN_geo
...
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE_geo
from holographic.materials_and_texture.holographic_material import Material as _Mat_geo, texture_field as _tex_geo, compose_object as _compose_geo
from holographic.agents_and_reasoning.holographic_ai import unbind as _unbind_geo, cosine as _cos_geo
...
from holographic.sampling_and_signal.holographic_fpefield import HolographicField as _HF_geo
from holographic.misc.holographic_displace import displace_sdf as _dsdf_geo
...
from holographic.mesh_and_geometry.holographic_terrain import Terrain as _Terr_geo, terrain_to_mesh as _t2m_geo
...
from holographic.agents_and_reasoning.holographic_grammar import LSystem as _LS_geo, turtle_to_segments as _turtle_geo
...
from holographic.misc.holographic_attributes import attribute_field as _af_geo, bake_to_vertices as _bake_geo
...
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_geo, box as _sbox_geo, torus as _stor_geo, menger as _meng_geo, parse_dsl as _pdsl_geo
...
from holographic.misc.holographic_typed import tree_to_recipe as _t2r_geo, op_kinds as _ok_geo
...
from holographic.io_and_interop.holographic_procgen import procedural_object as _po_geo, object_to_mesh as _o2m_geo, greeble_mesh as _gm_geo, vegetated_terrain as _vt_geo
from holographic.mesh_and_geometry.holographic_mesh import box as _mbox_geo
from holographic.scene_and_pipeline.holographic_scenegraph import flatten_scene as _fs_geo
...
from holographic.agents_and_reasoning.holographic_valuehead import HolographicValueHead as _HVH
from holographic.misc.holographic_creature import HolographicMind as _HM_vh
...
from holographic.misc.holographic_creature import CreatureEncoder as _CE_vh, GridWorld as _GW_vh, run_episode as _re_vh
...
from holographic.agents_and_reasoning.holographic_valuehead import RoutedValueHead as _RVH, HolographicValueHead as _PVH, decide_from_atom as _dfa, discounted_return as _dret
...
from holographic.misc.holographic_creature import CreatureEncoder as _CEbase, FastCreatureEncoder as _FCE, GridWorld as _GWp, HolographicMind as _HMp, run_episode as _rep
...
from holographic.agents_and_reasoning.holographic_ai import bind as _bnd, bundle as _bnl, unbind as _unb, bundle_bind as _bb, unbind_all as _ua
...
from holographic.misc.holographic_fields import diffuse as _dif, divergence as _dvg, project_divergence_free as _proj, advect as _adv, fluid_step as _fstep, ParticleSystem as _PS, attractor_force as _attr
_Hf = _Wf = 48
...
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SB, RigidBody as _RB
...
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SB2
from holographic.misc.holographic_fields import scatter_to_field as _scat, drag_force as _drag, fluid_step as _fs2
import math as _m2
def _fold(_with):
...
from holographic.misc.holographic_fields import smoke_step as _smk, curl as _crl2
_Hs = _Ws = 48
...
from holographic.misc.holographic_fields import fluid_step as _fso, disc_mask as _disc
_Ho = _Wo = 48
...
from holographic.misc.holographic_fields import project_divergence_free_3d as _p3, divergence_3d as _dv3, smoke_step_3d as _sm3
_N3 = 20
...
from holographic.mesh_and_geometry.holographic_tiling import tile as _tile, tile_recursive as _tilerec
...
from holographic.misc.holographic_fields import spectral_field as _spec, seam_continuity as _seam
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE
from holographic.mesh_and_geometry.holographic_tiling import grid_to_function as _g2f, tile as _tileq
...
from holographic.mesh_and_geometry.holographic_tiling import fractal_volume as _fvol
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE2
...
from holographic.agents_and_reasoning.holographic_ai import bind as _bv, unbind as _uv, cosine as _cv, random_vector as _rvv
...
from holographic.mesh_and_geometry.holographic_tiling import inception as _incep
...
import holographic.misc.holographic_fields as _Fz
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SB
_Nz = 18
...
from holographic.mesh_and_geometry.holographic_meshbridge import sample_field as _smf, marching_tetrahedra_vec as _mtv
from holographic.mesh_and_geometry.holographic_meshuv import stable_uv as _suv
def _sph(_P):
...
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SBtour
...
from holographic.sampling_and_signal.holographic_sampling import poisson_disk_sample as _pds, radial_power_spectrum as _rps
...
from holographic.mesh_and_geometry.holographic_meshpoly import face_type_counts as _ftc
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SBio, RigidBody as _RBio
from holographic.mesh_and_geometry.holographic_mesh import box as _boxio
def _sphio(_P):
    _P = _np_vh.asarray(_P, float); return _np_vh.linalg.norm(_P, axis=1) - 0.6
_bio = (_np_vh.array([-1., -1, -1]), _np_vh.array([1., 1, 1]))
import holographic.misc.holographic_unified as _huio
...
from holographic.mesh_and_geometry.holographic_meshbridge import sample_field as _sfio
...
from holographic.io_and_interop.holographic_encoders import ScalarEncoder as _SEio
...
import holographic.misc.holographic_unified as _hurd
_mind_rd = _hurd.UnifiedMind(dim=128, seed=0)
from holographic.mesh_and_geometry.holographic_meshbridge import sample_field as _sfrd, marching_tetrahedra_vec as _mtvrd
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _SceneDoc
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_sd, plane as _pln_sd, box as _box_sd
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _SceneSS
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_ss
...
import holographic.materials_and_texture.holographic_matlib as _MLh
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _SceneCr
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_cr
from holographic.rendering.holographic_scene_render import scene_to_render as _s2r_cr
...
from holographic.scene_and_pipeline.holographic_pipeline import RenderSpec as _RSv, PipelineConfig as _PCv, build_pipeline as _bpv
...
from holographic.scene_and_pipeline.holographic_pipeline import RenderSpec as _RSp, PipelineConfig as _PCp, build_pipeline as _bpp
from holographic.rendering.holographic_render import Camera as _Camp
from holographic.misc.holographic_integrate import ParticleSim as _PSp
...
from holographic.scene_and_pipeline.holographic_pipeline import RenderSpec as _RSh, PipelineConfig as _PCh, build_pipeline as _bph
from holographic.rendering.holographic_render import Camera as _Camh
from holographic.mesh_and_geometry.holographic_groom import groom as _groomh
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sphh
...
from holographic.rendering.holographic_thinfilm import thin_film_tint as _tft, interference_reflectance as _iref
...
from holographic.rendering.holographic_pathtrace import path_trace as _pt_l
from holographic.rendering.holographic_render import Camera as _Cam_l
from holographic.rendering.holographic_lights import PointLight as _PL, SphereLight as _SL, direct_lighting as _dl
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_l, box as _box_l
...
from holographic.rendering.holographic_lights import PointLight as _L_pt, SpotLight as _L_sp, RectLight as _L_rc, SphereLight as _L_sh, IESLight as _L_ie, MeshLight as _L_me, AmbientLight as _L_am, direct_lighting as _L_dl
...
# only where it isn't.
from holographic.caching_and_storage.holographic_domecache import render_dome_term as _dc_term, dome_light_sh as _dc_sh
from holographic.misc.holographic_prt import precompute_transfer as _dc_bake, shade_prt as _dc_shade
from holographic.mesh_and_geometry.holographic_sdf import box as _dc_box, sphere as _dc_sphere
from holographic.rendering.holographic_render import Camera as _dc_Cam
from holographic.rendering.holographic_lights import DomeLight as _dc_Dome
from holographic.caching_and_storage.holographic_domecache import _primary_gbuffer as _dc_gb
...
from holographic.misc.holographic_modulate import demodulate as _md_dm, remodulate as _md_rm, denoise_demodulated as _md_dd
from holographic.rendering.holographic_svgf import atrous_bilateral as _md_at
...
from holographic.misc.holographic_modulate import superres_demodulated as _m5_up
from holographic.rendering.holographic_fsr import easu_upscale as _m5_ez
...
from holographic.rendering.holographic_lightcache import cached_soft_lights_shade as _lc_cache, split_soft_lights as _lc_split
from holographic.caching_and_storage.holographic_domecache import _primary_gbuffer as _lc_gb
from holographic.mesh_and_geometry.holographic_sdf import box as _lc_box, sphere as _lc_sphere
from holographic.rendering.holographic_render import Camera as _lc_Cam
from holographic.rendering.holographic_lights import RectLight as _lc_Rect, PointLight as _lc_Point
...
from holographic.rendering.holographic_lightcache import cached_indirect_shade as _gi_cache
from holographic.mesh_and_geometry.holographic_sdf import box as _gi_box, sphere as _gi_sphere
from holographic.rendering.holographic_render import Camera as _gi_Cam
from holographic.rendering.holographic_lights import RectLight as _gi_Rect
...
from holographic.caching_and_storage.holographic_catalog import default_catalog as _cat_default, seed_from_mind as _cat_seed
_cat=_cat_default()
...
from holographic.scene_and_pipeline.holographic_pipeline import RenderSpec as _r1_Spec, Pipeline as _r1_Pipe, ALL_STAGES as _r1_STAGES
from holographic.scene_and_pipeline.holographic_pipeline import dispatch_render as _r1_disp, FrameState as _r1_FS, PipelineError as _r1_Err, RENDER_STRATEGIES as _r1_REG
from holographic.mesh_and_geometry.holographic_sdf import box as _r1_box, sphere as _r1_sphere
from holographic.rendering.holographic_render import Camera as _r1_Cam
...
from holographic.misc.holographic_fieldhome import Field as _r2_Field, field_backends as _r2_backends
...
from holographic.caching_and_storage.holographic_index import Index as _h1_Index, index_backends as _h1_backends
...
from holographic.caching_and_storage.holographic_cachehome import Cache as _h2_Cache, cache_backends as _h2_backends
from holographic.materials_and_texture.holographic_matbake import bake_field as _h2_bakefield
from holographic.mesh_and_geometry.holographic_sdfbake import bake_sdf_grid as _h2_bakesdf
...
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _r3_SM
from holographic.misc.holographic_param import Param as _r3_Param
from holographic.materials_and_texture.holographic_matbake import bake_material as _r3_bake
from holographic.rendering.holographic_brdf import cook_torrance as _r3_ct, lambert as _r3_lam
...
from holographic.sampling_and_signal.holographic_samplinghome import Sampling as _r4_S, sampling_backends as _r4_backends
from holographic.sampling_and_signal.holographic_lowdiscrepancy import low_discrepancy as _r4_ld
from holographic.rendering.holographic_globalillum import _cosine_hemisphere as _r4_gih
...
from holographic.rendering.holographic_denoisehome import Denoise as _r5_D, denoise_backends as _r5_backends
from holographic.rendering.holographic_svgf import atrous_bilateral as _r5_ab
...
from holographic.materials_and_texture.holographic_texturehome import Texture as _r6_T, texture_backends as _r6_backends
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _r6_SM
from holographic.misc.holographic_param import Param as _r6_Param
from holographic.materials_and_texture.holographic_matbake import bake_material as _r6_bake
...
from holographic.rendering.holographic_lightinghome import Lighting as _r7_L, lighting_modes as _r7_modes, DirectionalLight as _r7_Dir, RectLight as _r7_Rect
from holographic.rendering.holographic_lights import direct_lighting as _r7_dl
from holographic.mesh_and_geometry.holographic_sdf import sphere as _r7_sphere, box as _r7_box
...
from holographic.rendering.holographic_shadowhome import Shadow as _r8_S, shadow_strategies as _r8_strats
from holographic.rendering.holographic_raymarch import soft_shadow as _r8_ss, ambient_occlusion as _r8_ao
from holographic.mesh_and_geometry.holographic_sdf import sphere as _r8_sphere, box as _r8_box
...
from holographic.misc.holographic_scalehome import Scale as _h3_S, scale_strategies as _h3_strats, scale_backends as _h3_be
...
from holographic.misc.holographic_blendhome import Blend as _h4_B, blend_backends as _h4_be
from holographic.misc.holographic_blendpose import blend_pose as _h4_bp
from holographic.agents_and_reasoning.holographic_ai import slerp as _h4_slerp
...
from holographic.misc.holographic_transformhome import Transform as _h5_T, transform_kinds as _h5_kinds
import holographic.misc.holographic_transform as _h5_TF, holographic.scene_and_pipeline.holographic_scenegraph as _h5_SG
...
from holographic.agents_and_reasoning.holographic_ai import bind as _h5_bind
...
from holographic.simulation_and_physics.holographic_memoryhome import Memory as _h6_M, memory_levers as _h6_lev
from holographic.agents_and_reasoning.holographic_ai import bind as _h6_bind, bundle as _h6_bundle
...
from holographic.misc.holographic_computehome import Compute as _h7_C, compute_levers as _h7_lev
from holographic.agents_and_reasoning.holographic_ai import bind as _h7_bind, bundle as _h7_bundle
...
from holographic.misc.holographic_simulationhome import Simulation as _r9_Sim, known_solver_strategies as _r9_strats
from holographic.simulation_and_physics.holographic_fluid import StableFluid as _r9_SF
from holographic.misc.holographic_automaton import HyperCA as _r9_CA
from holographic.rendering.holographic_render import Camera as _r9_Cam
...
from holographic.sampling_and_signal.holographic_hypervector import Hypervector as _d1_HV
from holographic.agents_and_reasoning.holographic_ai import bind as _d1_bind, unbind as _d1_unbind, bundle as _d1_bundle, permute as _d1_permute, cosine as _d1_cos
from holographic.io_and_interop.holographic_encoders import ScalarEncoder as _d1_Enc
...
from holographic.misc.holographic_computehome import Compute as _re_C
from holographic.misc.holographic_regimegate import RegimeGate as _re_G
from holographic.agents_and_reasoning.holographic_ai import bind as _re_bind
...
from holographic.simulation_and_physics.holographic_loadmemory import AdaptiveRoleFillerMemory as _re2_M
...
from holographic.simulation_and_physics.holographic_loadmemory import AdaptiveRoleFillerMemory as _re3_M
...
from holographic.rendering.holographic_brdf import directional_albedo as _re4_ss, directional_albedo_ms as _re4_ms, brdf_gated as _re4_g
...
from holographic.misc.holographic_coarsefirst import refine_where_uncertain as _re5_refine, gradient_uncertainty as _re5_unc, concentration as _re5_conc
...
from holographic.sampling_and_signal.holographic_nystrom import apply_kernel_gated as _re6_g, exact_kernel_apply as _re6_ex
...
from holographic.rendering.holographic_splat import splat_fit as _re7_sf, splat_render as _re7_sr, fit_coarse_first as _re7_cf, psnr as _re7_psnr
...
from holographic.agents_and_reasoning.holographic_query import Database as _qh_DB, update as _qh_upd
from holographic.agents_and_reasoning.holographic_querytime import TableHistory as _qh_TH, select_as_of as _qh_asof, diff_versions as _qh_diff, find_tampering as _qh_tamper
...
from holographic.agents_and_reasoning.holographic_queryprog import ProgramCatalog as _pp_Cat
...
from holographic.agents_and_reasoning.holographic_query import Database as _wf_DB
from holographic.agents_and_reasoning.holographic_queryfolder import FolderTree as _wf_FT, _bare as _wf_bare
from holographic.scene_and_pipeline.holographic_scene import SceneCoder as _wf_SC, COLOURS as _wf_C, SHAPES as _wf_S, TEXTURES as _wf_T
...
from holographic.agents_and_reasoning.holographic_query import Database as _gl_DB, update as _gl_upd
from holographic.agents_and_reasoning.holographic_querygraph import EdgeGraph as _gl_EG
from holographic.agents_and_reasoning.holographic_querylock import SingleWriterLock as _gl_SWL, ConcurrencyError as _gl_CE
...
from holographic.scene_and_pipeline.holographic_coordinator import Coordinator as _co_C, InProcessBackend as _co_IP, LocalPool as _co_LP, decide as _co_decide, _sum_bucket as _co_sum
from holographic.scene_and_pipeline.holographic_distribute import reduce_sum as _co_rs
...
from holographic.scene_and_pipeline.holographic_command import CommandRunner as _cr_CR, CommandError as _cr_CE, command_as_tool as _cr_tool
from holographic.agents_and_reasoning.holographic_ai import Vocabulary as _cr_Vocab
...
from holographic.scene_and_pipeline.holographic_coordinator import Coordinator as _nf_C
from holographic.misc.holographic_farm import WorkerDaemon as _nf_WD, NetworkFarm as _nf_NF, _sum_indices as _nf_sum, _content_hash as _nf_hash
from holographic.scene_and_pipeline.holographic_distribute import reduce_sum as _nf_rs
...
from holographic.misc.holographic_hardening import agree as _h5_agree, NoConsensus as _h5_NC, HardenedCoordinator as _h5_HC, CanaryFailed as _h5_CF, _sum_bucket as _h5_sum, _FlakyBackend as _h5_Flaky
from holographic.scene_and_pipeline.holographic_coordinator import InProcessBackend as _h5_IP
from holographic.scene_and_pipeline.holographic_distribute import reduce_sum as _h5_rs
...
from holographic.scene_and_pipeline.holographic_jobs import JobManager as _jl_JM, _sum_bucket as _jl_w, DONE as _jl_DONE, PAUSED as _jl_PAUSED
from holographic.scene_and_pipeline.holographic_coordinator import InProcessBackend as _jl_IP
...
import holographic.materials_and_texture.holographic_materialindex as _mat_idx
...
import holographic.misc.holographic_dictionary as _dic
_dic_n=_dic.size()
...
from holographic.caching_and_storage.holographic_catalog import default_catalog as _tw_cat, seed_from_modules as _tw_seed
...
import holographic.misc.holographic_skills as _ag
...
from holographic.simulation_and_physics.holographic_scene_semantic import scene_from_description as _sfd
...
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE_mm
from holographic.materials_and_texture.holographic_material import Material as _Mat_mm, texture_field as _tf_mm
...
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE_lm
from holographic.materials_and_texture.holographic_material import Material as _Mat_lm, texture_field as _tf_lm
from holographic.materials_and_texture.holographic_layeredmaterial import LAYER_RANK as _LM_RANK
...
from holographic.mesh_and_geometry.holographic_mesh import box as _box_in
from holographic.scene_and_pipeline.holographic_scenegraph import translation as _tr_in
...
from holographic.mesh_and_geometry.holographic_mesh import box as _box_rg
from holographic.scene_and_pipeline.holographic_scenegraph import translation as _tr_rg
from holographic.rendering.holographic_rendergraph import BakedTexture as _BT_rg
...
from holographic.sampling_and_signal.holographic_fpe import VectorFunctionEncoder as _VFE_pv
from holographic.materials_and_texture.holographic_material import Material as _Mat_pv, texture_field as _tf_pv
...
from holographic.simulation_and_physics.holographic_semantic import _UnionSDF as _Union_tr
from holographic.rendering.holographic_raymarch import sphere_trace as _st_tr
from holographic.rendering.holographic_render import Camera as _Cam_tr
...
import holographic.misc.holographic_dictionary as _hd_tour
_hd_tour.unload()
...
from holographic.agents_and_reasoning.holographic_query import Database as _DB
...
try:
    ...
    from holographic.mesh_and_geometry.holographic_mesh import box as _box_ai
    from holographic.io_and_interop.holographic_gltf import mesh_to_glb as _m2g
    from holographic.materials_and_texture.holographic_materialio import PBRMaterial as _PBR
    ...
    from holographic.rendering.holographic_render import Camera as _CamAI
    ...
    from holographic.io_and_interop.holographic_assetimport import LoadedMesh as _LM_ai, AnimationClip as _AC_ai
...
from holographic.misc.holographic_refine import opponent_critic as _op_crit
...
_tagged = _bo.tag(_pv)
from holographic.caching_and_storage.holographic_provenance import of_source as _of_source
...
from holographic.misc.holographic_access import require_readable as _require_readable, AccessError as _AccessError
...
from holographic.scene_and_pipeline.holographic_coordinator import Coordinator as _FCoord, InProcessBackend as _FLocal, WorkerNode as _FNode, _make_worker_handler as _f_handler, _sum_bucket as _f_sum
from holographic.scene_and_pipeline.holographic_distribute import reduce_sum as _f_reduce
...
from holographic.scene_and_pipeline.holographic_distbus import _make_bus_handler as _b_handler
_b_servers = []
...
from holographic.rendering.holographic_render import volume_render as _vrfn
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_an
from holographic.mesh_and_geometry.holographic_mesh import box as _box_an, grid as _grid_an, Mesh as _Mesh_an
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_li
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sph_li, plane as _pl_li, torus as _tor_li
from holographic.rendering.holographic_render import Camera as _Cam_li
from holographic.mesh_and_geometry.holographic_mesh import grid as _grid_li
...
from holographic.rendering.holographic_raymarch import sdf_normal as _sn_li
...
from holographic.rendering.holographic_globalillum import gather_indirect as _gi_li
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_ny
from holographic.sampling_and_signal.holographic_nystrom import dense_embedding as _de_ny, subspace_alignment as _sa_ny
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_oc
from holographic.mesh_and_geometry.holographic_octree import single_wave_recall as _swr_oc
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_sy
from holographic.scene_and_pipeline.holographic_orchestrator import chain_signature as _csig_sy
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_ag
from holographic.agents_and_reasoning.holographic_ai import random_vector as _rv_ag
from holographic.misc.holographic_voidsynth import blend_programs as _blp_ag
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_dr
from holographic.misc.holographic_drives import make_nested_process as _mnp
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_ah
from holographic.agents_and_reasoning.holographic_ai import cosine as _cos_ah
from holographic.sampling_and_signal.holographic_nystrom import farthest_point_landmarks as _fps_ah
...
from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HM_st
from holographic.agents_and_reasoning.holographic_ai import cosine as _cos_st, unbind as _unb_st
...
from holographic.agents_and_reasoning.holographic_deltachain import DeltaChain as _DC_dl, IntegrityError as _IE_dl
...
from holographic.misc.holographic_unified import UnifiedMind as _UM_4
from holographic.agents_and_reasoning.holographic_ai import bind as _bind4, cosine as _cos4
from holographic.sampling_and_signal.holographic_nystrom import exact_kernel_apply as _exk4
from holographic.agents_and_reasoning.holographic_dream import on_manifold as _onm4
...
from holographic.agents_and_reasoning.holographic_dream import subspace_alignment as _sal4
...
from holographic.simulation_and_physics.holographic_fluid import StableFluid as _SF
...
from holographic.rendering.holographic_brdf import directional_albedo as _dalb, sample_ggx as _sggx, cook_torrance as _ctb
from holographic.rendering.holographic_pathtrace import path_trace as _pt, constant_material as _cmat
...
from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HM_s
...
from holographic.misc.holographic_backend import device_report as _drep, array_module as _amod
...
from holographic.mesh_and_geometry.holographic_sphere import frechet_mean as _fmean, geodesic_variance as _gvar, parallel_transport as _ptrans
from holographic.agents_and_reasoning.holographic_ai import geodesic as _geo, exp_map as _expm
...
from holographic.misc.holographic_cosmic import participation_ratio as _pr_c, _local_pca as _lpca_c, classify_cloud as _ccloud
...
from holographic.rendering.holographic_lens import deflect as _deflect_l, detect_caustic as _caustic_l, navigate as _nav_l, _normalize as _norm_l
from holographic.agents_and_reasoning.holographic_ai import geodesic as _geo_l
...
from holographic.misc.holographic_jit import signed_distance_2d as _sdf_j, _fast_sweep_2d as _fs_j, _fast_sweep_2d_impl as _fsi_j, _BIG as _BIG_j, HAS_NUMBA as _HAS_NB_j
_N_j = 128; _R_j = 40.0
...
from holographic.misc.holographic_codegen import HAS_SYMPY as _HAS_SP_c, sdf_normal_fn as _sdfn_c, gradient_fn as _gradfn_c
if _HAS_SP_c:
    _R_c = 1.3
...
from holographic.sampling_and_signal.holographic_fft import fft_backend as _fftb_c, HAS_PYFFTW as _HAS_PF_c, benchmark as _fftbench_c
...
from holographic.scene_and_pipeline.holographic_compile import CompileCache as _CC_cc, compiled_sdf_normal as _csn_cc, DEFAULT_CACHE as _DC_cc
from holographic.misc.holographic_codegen import HAS_SYMPY as _HAS_SP_cc
...
from holographic.scene_and_pipeline.holographic_compile import compiled_sdf_numba as _csn2, compiled_program as _cprog2, DEFAULT_CACHE as _DC2
from holographic.misc.holographic_codegen import HAS_SYMPY as _HSP2
from holographic.misc.holographic_jit import HAS_NUMBA as _HNB2
from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _HM2
...
from holographic.misc.holographic_codegen import HAS_SYMPY as _HSP_sr
from holographic.misc.holographic_jit import HAS_NUMBA as _HNB_sr
if _HSP_sr and _HNB_sr:
    import time as _time_sr
    from holographic.rendering.holographic_render import Camera as _Cam_sr
    from holographic.rendering.holographic_raymarch import render_sdf as _rsdf_sr, sphere_trace as _st_sr
    from holographic.rendering.holographic_sdf_render import render_analytic as _ra_sr, compiled_sdf_renderer as _csr_sr
    class _SphObj_sr:
...
from holographic.misc.holographic_codegen import HAS_SYMPY as _HSP_sw
from holographic.misc.holographic_jit import HAS_NUMBA as _HNB_sw
from holographic.caching_and_storage.holographic_cache import gradient_cache_fd as _gcfd_sw, gradient_cache_symbolic as _gcsym_sw
...
if _HSP_sw and _HNB_sw:
    ...
    from holographic.misc.holographic_codegen import sphere as _sph_sw, box as _box_sw, op_union as _u_sw, op_subtract as _sub_sw
    from holographic.rendering.holographic_render import Camera as _Cam_sw
    from holographic.rendering.holographic_raymarch import render_sdf as _rs_sw, sphere_trace as _st_sw
    from holographic.rendering.holographic_sdf_render import render_analytic as _ra_sw, compiled_sdf_renderer as _csr_sw
...
from holographic.misc.holographic_jit import signed_distance_3d as _sd3, _fast_sweep_3d as _fs3, _fast_sweep_3d_impl as _fs3i, _BIG as _BIG3, HAS_NUMBA as _HN3
...
from holographic.rendering.holographic_postfx import default_chain as _dc_px, PostChain as _PC_px, _fft_blur as _fb_px
...
from holographic.simulation_and_physics.holographic_semantic import parse_description as _pd_se, encode_scene as _es_se, query_scene as _qs_se, batch_set as _bs_se, find_objects as _fo_se, control_spec as _cs_se
_mind_se = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=1024, seed=0)
...
from holographic.simulation_and_physics.holographic_semantic import SynonymResolver as _SR_s2, parse_description as _pd_s2, render_scene as _rs_s2
from holographic.rendering.holographic_render import Camera as _Cam_s2
_r_s2 = _SR_s2()
...
_hr_mind = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=1024, seed=0)
from holographic.simulation_and_physics.holographic_semantic import parse_description as _pd_hr, render_scene_pbr as _rspbr, _pbr_props as _pbr_hr
from holographic.rendering.holographic_render import Camera as _Cam_hr
...
_vi_enc = importlib.import_module("holographic.sampling_and_signal.holographic_fpe").VectorFunctionEncoder(3, dim=2048, bounds=[(-2, 2)] * 3, kernel="rbf", bandwidth=2.2, seed=0)
_vi_vol = importlib.import_module("holographic.misc.holographic_volint").HolographicVolume.from_blobs(_vi_enc, [(-0.5, 0, 0), (0.6, 0.2, -0.4), (0.0, -0.5, 0.4)], [1.0, 0.8, 0.6])
...
_rf_TRF = importlib.import_module("holographic.rendering.holographic_radiance").TiledRadianceField
_rf_HRF = importlib.import_module("holographic.rendering.holographic_radiance").HolographicRadianceField
_rf_VFE = importlib.import_module("holographic.sampling_and_signal.holographic_fpe").VectorFunctionEncoder
...
from holographic.simulation_and_physics.holographic_semantic import parse_description as _ri_pd, render_scene as _ri_rs, _scene_setup as _ri_ss
from holographic.rendering.holographic_rayindex import build_ray_index as _ri_bi, delta_reshade as _ri_dr
from holographic.rendering.holographic_render import Camera as _ri_Cam
...
from holographic.rendering.holographic_rayindex import build_brick_index as _bk_build, delta_reshade_move as _bk_move
from holographic.simulation_and_physics.holographic_semantic import _shade_rays as _bk_shade
...
from holographic.rendering.holographic_rayindex import _object_aabb as _mg_aabb
...
from holographic.rendering.holographic_rayindex import IncrementalRenderer as _IR
...
from holographic.misc.holographic_regionfield import RegionField as _RF, Region as _Rg
from holographic.simulation_and_physics.holographic_semantic import _SphereSDF as _Sph, _BoxSDF as _Bx
_rg_field = _RF([
...
from holographic.simulation_and_physics.holographic_semantic import realize_scene as _rlz
from holographic.rendering.holographic_raycoherence import reflect_transform as _reflT, trace_reflection_color as _trefl, coherent_reflection as _cohR
from holographic.rendering.holographic_raymarch import sphere_trace as _st, sdf_normal as _sn
...
from holographic.rendering.holographic_raydiff import transport_pencil as _tp, find_focus as _ff, pencil_radius_at as _pr, reflect_off_sphere as _ros, perpendicular_basis as _pb, lobe_sigma as _ls, dispersion_spread as _ds
...
from holographic.misc.holographic_ndfield import solve_grid_maze as _sgm, sparse_reconstruct as _srec, _nadaraya_watson as _nw
...
from holographic.misc.holographic_ndfield import navigate_field as _nf, path_cost as _pcst, straight_line_cells as _slc
from holographic.simulation_and_physics.holographic_semantic import volumetric_field as _volf, realize_scene as _rlz2
...
from holographic.rendering.holographic_raymarch import sphere_trace as _st2
...
from holographic.misc.holographic_ndfield import navigate_scene as _nsc, encode_path as _enp, decode_path_step as _dps
from holographic.simulation_and_physics.holographic_semantic import realize_scene as _rlz3, _scene_setup as _ssup
...
from holographic.misc.holographic_param import Param as _Pm, resolve_param as _rp
from holographic.simulation_and_physics.holographic_emitter import emit_from_surface as _efs, advance as _adv
...
from holographic.simulation_and_physics.holographic_collide import resolve_sdf_collision as _rsc, sdf_collision_projection as _scp
from holographic.simulation_and_physics.holographic_softbody import SoftBody as _SB
...
from holographic.misc.holographic_dirtyfield import DirtyField as _DF
...
import time as _pt
from holographic.rendering.holographic_raymarch import sphere_trace as _stz
from holographic.mesh_and_geometry.holographic_sdfbake import GridSDF as _GS
...
from holographic.rendering.holographic_raymarch import sphere_trace as _prt_st, sdf_normal as _prt_nrm, soft_shadow as _prt_ss
from holographic.misc.holographic_prt import precompute_transfer as _prt_pre, project_env_to_sh as _prt_env, shade_prt as _prt_shade
class _PRTCluster:
...
from holographic.misc.holographic_ndfield import field_weighted_graph as _ctg_g, least_cost_path as _ctg_dij, cost_to_go as _ctg_solve, route_from as _ctg_route, path_cost as _ctg_pc
_ctg_shape = (26, 26, 16)
...
from holographic.scene_and_pipeline.holographic_dispatch import dispatch_field as _disp, resolve_methods as _rmeth
...
from holographic.misc.holographic_adaptive import plan_render as _plan
...
from holographic.scene_and_pipeline.holographic_distribute import partition as _dpart, distribute as _dist, distribute_scatter as _dscat, reduce_sum as _rsum, reduce_min as _rmin, adaptive_partition as _dadapt
from holographic.misc.holographic_fields import attractor_force as _attr
...
from holographic.scene_and_pipeline.holographic_distribute import reduce_sum_exact as _rexact, reduce_sum as _rsum2
...
from holographic.scene_and_pipeline.holographic_dispatch import bake_scene as _bscene, render_baked as _rbaked
class _BkS:
...
from holographic.scene_and_pipeline.holographic_distribute import partition_2d as _p2d, partition_3d as _p3d, distribute_bricks as _dbrick
...
from holographic.misc.holographic_pattern import make_pattern as _mkpat, field_lerp as _flerp
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _SurfMat, render_surface as _rsurf
from holographic.misc.holographic_param import Param as _SParam
class _SM_Balls:
...
from holographic.scene_and_pipeline.holographic_session import RenderSession as _RSess
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _RS_Mat
from holographic.misc.holographic_param import Param as _RS_Param
from holographic.misc.holographic_pattern import make_pattern as _rs_mk, field_lerp as _rs_lerp
class _RS_Two:
    cs = _ri_np.array([[0.0, 0, 0], [1.9, 0, 0]])
    def eval(s, P): return _ri_np.min(_ri_np.stack([_ri_np.linalg.norm(P - c, axis=1) - 0.85 for c in s.cs]), axis=0)
    def ids(s, P): return _ri_np.argmin(_ri_np.stack([_ri_np.linalg.norm(P - c, axis=1) for c in s.cs]), axis=0)
...
import holographic.materials_and_texture.holographic_matlib as _pd_ml
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _PD_Mat
from holographic.scene_and_pipeline.holographic_session import RenderSession as _PD_Sess
from holographic.misc.holographic_definitions import resolve_scenario as _pd_resolve, MATERIALS as _PD_MATERIALS
from holographic.misc.holographic_quantities import bill_mass as _pd_bmass, bill_cost as _pd_bcost, bill_embodied_carbon as _pd_bco2, SAMPLE_PRICE_USD_PER_KG as _PD_PRICE, SAMPLE_CARBON_KG_PER_KG as _PD_CO2, Quantity as _PD_Q
from holographic.misc.holographic_definitions import build_standard_library as _pd_lib
...
from holographic.materials_and_texture.holographic_grainmat import wood_grain as _sm_grain
from holographic.misc.holographic_inclusions import inclusion_coverage as _sm_cov, with_inclusions as _sm_incl
from holographic.simulation_and_physics.holographic_cellular import VoronoiCells as _sm_Vor, cell_albedo as _sm_cellalb, lattice as _sm_lat
...
from holographic.misc.holographic_blackbody import blackbody_rgb as _th_bb, peak_wavelength_nm as _th_wien
from holographic.simulation_and_physics.holographic_heat import diffuse_heat as _th_diff, HeatBody as _th_Body, material_thermal as _th_mt
from holographic.simulation_and_physics.holographic_gas import speed_of_sound as _th_sos, adiabatic as _th_adia, boiling_point as _th_boil
...
_th_air_sos = float(_th_sos(293.15, "air")); _th_tab = float(_ri_np.asarray(importlib.import_module("holographic.misc.holographic_definitions").MATERIALS["air"]["sound_speed"]))
...
from holographic.simulation_and_physics.holographic_combustion import COMBUSTION as _pr_COMB, ignites as _pr_ign, combustion_products as _pr_prod, Fire as _pr_Fire
from holographic.misc.holographic_phase import PhaseState as _pr_Phase, boiling_point_at as _pr_boil
...
from holographic.simulation_and_physics.holographic_oxidation import OxidationField as _bx_Ox, oxide_color as _bx_oxc
from holographic.misc.holographic_burn import BurningObject as _bx_Burn, char_color as _bx_char
from holographic.simulation_and_physics.holographic_elements import element as _bx_el, molar_mass as _bx_mm, flame_color_of as _bx_fc, material_elemental as _bx_me
...
from holographic.simulation_and_physics.holographic_cymatics import ChladniPlate as _a5_Plate
from holographic.simulation_and_physics.holographic_wave import WaveField as _a3_Wave
...
from holographic.simulation_and_physics.holographic_nonnewtonian import power_law_viscosity as _nn_eta, viscous_step as _nn_visc
...
from holographic.simulation_and_physics.holographic_levitate import LevitationChamber as _af_Lev, pressure_nodes as _af_nodes, gorkov_force_y as _af_F
from holographic.misc.holographic_roomacoustic import ShoeboxRoom as _af_Room
_af_lam = 0.0086
...
from holographic.mesh_and_geometry.holographic_curlnoise import curl_noise as _sg_curl, divergence as _sg_div
from holographic.mesh_and_geometry.holographic_tear import TearableCloth as _sg_Tear, tear_strength as _sg_ts
...
from holographic.misc.holographic_wos import walk_on_spheres as _wos
...
from holographic.mesh_and_geometry.holographic_groom import groom as _hair_groom, simulate_strands as _hair_sim, interpolate_strands as _hair_interp, CurlWind as _HairWind
from holographic.mesh_and_geometry.holographic_hairshade import kajiya_kay as _hair_kk, marschner as _hair_mar, render_hair as _hair_render
from holographic.mesh_and_geometry.holographic_sdf import sphere as _hair_sphere
...
from holographic.simulation_and_physics.holographic_cosserat import CosseratStrand as _CosStrand
...
from holographic.misc.holographic_fuse import leaf as _f_leaf, fbind as _f_bind, fbundle as _f_bundle, funbind as _f_unbind, fuse as _f_fuse, fuse_record as _f_record, reset_fft_counts as _f_reset, fft_counts as _f_counts
from holographic.agents_and_reasoning.holographic_ai import bundle_bind as _ca_bb
from holographic.scene_and_pipeline.holographic_schedule import leaf as _s_leaf, op_bind as _s_bind, op_bundle as _s_bundle, op_unbind as _s_unbind, op_cleanup as _s_clean, run_sequential as _s_seq, run_scheduled as _s_sch
...
from holographic.misc.holographic_recipe import StructureRecipe as _CaRecipe
from holographic.scene_and_pipeline.holographic_schedule import run_recipe as _ca_run_recipe
...
from holographic.misc.holographic_spatial import SpatialGrid as _S3Grid, brute_knn as _s3_bknn
from holographic.misc.holographic_automaton import HyperCA as _S3CA
from holographic.simulation_and_physics.holographic_emergence import EmergentConcepts as _S3EC
from holographic.simulation_and_physics.holographic_temporal import TemporalReuse as _S3TR
...
from holographic.sampling_and_signal.holographic_spharm import sphere_dirs as _s3m_dirs, sh_project as _s3m_proj, sh_reconstruct as _s3m_rec
from holographic.misc.holographic_condprop import ConditionalPropagator as _S3MCP
from holographic.caching_and_storage.holographic_storage import StorageSpine as _S3MSpine
...
from holographic.misc.holographic_analog import AnalogForecaster as _AF, delay_embed as _dembed
from holographic.misc.holographic_forecast import route_and_forecast as _route
from holographic.misc.holographic_horizon import MultiHorizonForecaster as _MHF
...
from holographic.rendering.holographic_svgf import atrous_bilateral as _atrous, plain_blur as _pblur, _psnr as _psnr_fn
...
from holographic.agents_and_reasoning.holographic_query import from_rows as _qfrom, run_sql as _qsql, Query as _QQ
_q_rows = [
...
from holographic.misc.holographic_unified import UnifiedMind as _QMind
...
from holographic.agents_and_reasoning.holographic_machine import HoloMachine as _QMac
...
from holographic.agents_and_reasoning.holographic_query import Database as _QDB
...
from holographic.scene_and_pipeline.holographic_superschedule import calibrated_capacity as _sw_cc, pack_capacity as _sw_pc
from holographic.sampling_and_signal.holographic_adaptive_sample import sample_budget as _sw_sb
...
from holographic.sampling_and_signal.holographic_spectralfield import diffusion_field as _sf_diff, wave_field as _sf_wave
from holographic.simulation_and_physics.holographic_heat import diffuse_heat as _sf_heat
_sf_N = 128
...
from holographic.simulation_and_physics.holographic_waveadaptive import plan_waves as _aw_plan, plan_cost as _aw_cost, method_counts as _aw_counts, all_one_method_cost as _aw_all
_aw_H = _aw_W = 64
...
from holographic.simulation_and_physics.holographic_wavepacket import WavePacketField as _wp_Field
...
from holographic.misc.holographic_transform import compose_trs as _tx_compose, decompose as _tx_decompose, quat_from_euler as _tx_qe, quat_to_matrix as _tx_qm, quat_slerp as _tx_slerp, quat_from_axis_angle as _tx_qaa, quat_to_axis_angle as _tx_q2aa, look_at as _tx_lookat
from holographic.misc.holographic_cancel import CancelToken as _tx_Cancel
from holographic.rendering.holographic_pathtrace import path_trace as _tx_pt
from holographic.rendering.holographic_render import Camera as _tx_Cam
from holographic.mesh_and_geometry.holographic_sdf import sphere as _tx_sphere
...
from holographic.misc.holographic_modifier import ModifierStack as _ms_Stack
_ms_calls = {"n": 0}
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _sd_Scene
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _sq_Scene
from holographic.agents_and_reasoning.holographic_scene_query import select as _sq_select, select_fuzzy as _sq_fuzzy, select_by_tag as _sq_bytag, tag as _sq_tag, Selection as _sq_Selection
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _un_Scene
...
from holographic.misc.holographic_metrology import surface_area as _me_area, volume as _me_vol, bounding_box as _me_bbox, edge_length as _me_edge, _unit_cube as _me_cube
_me_c = _me_cube()
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _ov_Scene
from holographic.misc.holographic_overrides import resolve as _ov_resolve, set_override as _ov_set
from holographic.caching_and_storage.holographic_snap import Snapper as _ov_Snapper, snap_to_points as _ov_snap_pts
...
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _gc_Scene
from holographic.misc.holographic_grouping import group_objects as _gc_group, group_members as _gc_members, instance as _gc_inst, resolve_geometry as _gc_geo
from holographic.rendering.holographic_camera import CameraController as _gc_Cam
from holographic.misc.holographic_metrology import _unit_cube as _gc_cube, bounding_box as _gc_bbox
...
from holographic.sampling_and_signal.holographic_sampler import Sampler as _sm_Sampler, owners_from_sdfs as _sm_owners, contribution_of as _sm_contrib, dominant_owner as _sm_dom
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sm_sphere
class _sm_Shift:
...
from holographic.mesh_and_geometry.holographic_autobump import auto_bump as _ab_auto
_ab_N = 48
...
from holographic.mesh_and_geometry.holographic_surfaceint import height_from_normals as _si_hfn
from holographic.mesh_and_geometry.holographic_autobump import normal_from_height as _si_nfh
_si_H, _si_W = 48, 64
...
from holographic.materials_and_texture.holographic_colortransfer import color_transfer as _ct_transfer
...
from holographic.mesh_and_geometry.holographic_autodisplace import auto_displace as _ad_auto
from holographic.mesh_and_geometry.holographic_mesh import grid as _ad_grid
_ad_Ni = 48
...
from holographic.io_and_interop.holographic_imagecompare import perceptual_similarity as _ic_sim, _shift as _ic_shift
from holographic.mesh_and_geometry.holographic_autobump import gaussian_blur as _ic_blur
...
from holographic.rendering.holographic_inverserender import render_params as _as_render, recover_scene as _as_recover, calibrate_accept_threshold as _as_cal
from holographic.mesh_and_geometry.holographic_sdf import box as _as_box
...
from holographic.agents_and_reasoning.holographic_perception import SceneLibrary as _pc_Lib
from holographic.rendering.holographic_inverserender import render_params as _pc_render, recover_scene as _pc_recover
from holographic.mesh_and_geometry.holographic_sdf import box as _pc_box
...
from holographic.rendering.holographic_renderchannels import render_channels as _rc_channels, composites_to_beauty as _rc_comp
from holographic.rendering.holographic_render import Camera as _rc_Cam
from holographic.mesh_and_geometry.holographic_sdf import box as _rc_box, sphere as _rc_sphere
from holographic.rendering.holographic_raymarch import render_sdf as _rc_render
...
from holographic.rendering.holographic_fsr import easu_upscale as _fsr_easu, _box_downscale as _fsr_down, _psnr as _fsr_psnr, _edge_energy as _fsr_edge
from holographic.rendering.holographic_postfx import resample as _fsr_resample
...
from holographic.rendering.holographic_checkerboard import render_checkerboard as _cb_render, _shade_all as _cb_full, _row_halved as _cb_rowh, _psnr as _cb_psnr
from holographic.rendering.holographic_render import Camera as _cb_Cam
from holographic.mesh_and_geometry.holographic_sdf import box as _cb_box
...
from holographic.misc.holographic_objectarchive import ObjectArchive as _oa_Arch, front_points as _oa_front, _chamfer as _oa_cham, _sphere as _oa_sphere, _box as _oa_box, _cylinder as _oa_cyl, _cone as _oa_cone
_oa_view = (0, 0, 1)
...
from holographic.materials_and_texture.holographic_texturesynth import synthesize_texture as _ts_syn, find_similar_patches as _ts_find, _seam_energy as _ts_seam
...
from holographic.rendering.holographic_superres import guided_upsample as _sr_guided, _psnr as _sr_psnr
from holographic.rendering.holographic_renderchannels import render_channels as _sr_channels
from holographic.rendering.holographic_render import Camera as _sr_Cam
from holographic.mesh_and_geometry.holographic_sdf import box as _sr_box
from holographic.rendering.holographic_raymarch import render_sdf as _sr_render
from holographic.rendering.holographic_fsr import easu_upscale as _sr_easu, _box_downscale as _sr_down
...
from holographic.misc.holographic_smokepresets import simulate as _sm_sim, plume_center_of_mass as _sm_com, _buoyant_vs_heavy as _sm_bvh
...
from holographic.misc.holographic_mixture import Mixture as _mx_M, matter_step as _mx_step, _blob as _mx_blob, _spatial_spread as _mx_spread
_mx_shape = (48, 48)
...
from holographic.misc.holographic_mixture import Mixture as _dr_M, matter_step as _dr_step, _blob as _dr_blob
def _dr_comy(_f, _sh):
...
from holographic.misc.holographic_mixture import Mixture as _dw_M, matter_step as _dw_step
_dw_sh = (48, 48)
...
from holographic.rendering.holographic_scatterlayer import ScatterLayer as _sc_L
from holographic.misc.holographic_scalenode import ScaleNode as _sc_N
from holographic.mesh_and_geometry.holographic_sdf import sphere as _sc_sphere
from holographic.scene_and_pipeline.holographic_scene_doc import Scene as _sc_Scene
from holographic.agents_and_reasoning.holographic_ai import Vocabulary as _sc_Voc
...
from holographic.materials_and_texture.holographic_matcompile import compiled_shader as _mc_shader
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _mc_Mat
from holographic.misc.holographic_param import Param as _mc_Param
from holographic.scene_and_pipeline.holographic_compile import CompileCache as _mc_Cache
...
from holographic.materials_and_texture.holographic_matbake import bake_material as _mb_bake
from holographic.mesh_and_geometry.holographic_surface import SurfaceMaterial as _mb_Mat
from holographic.misc.holographic_param import Param as _mb_Param
...
from holographic.rendering.holographic_viewlut import bake_view_lut as _vl_bake
from holographic.rendering.holographic_brdf import directional_albedo as _vl_da
...
from holographic.scene_and_pipeline.holographic_pipecompile import compiled_pipeline as _pc_comp, run_compiled as _pc_run
from holographic.scene_and_pipeline.holographic_pipeline import PipelineConfig as _pc_Cfg, build_pipeline as _pc_build
from holographic.scene_and_pipeline.holographic_compile import CompileCache as _pc_Cache
_pc_cache = _pc_Cache()
...
from holographic.misc.holographic_simreadout import diffuse_at as _sr_at, diffuse_limit as _sr_limit
from holographic.misc.holographic_fields import diffuse as _sr_diffuse
...
from holographic.scene_and_pipeline.holographic_stageplan import plan_stages as _sp_plan
from holographic.scene_and_pipeline.holographic_pipecompile import compiled_pipeline as _sp_comp
from holographic.scene_and_pipeline.holographic_pipeline import PipelineConfig as _sp_Cfg
from holographic.scene_and_pipeline.holographic_compile import CompileCache as _sp_Cache
...
from holographic.misc.holographic_transfer import scatter as _tr_scatter, gather as _tr_gather
from holographic.misc.holographic_fields import scatter_to_field as _tr_fld_scatter
from holographic.simulation_and_physics.holographic_mpm import MPMSnow as _tr_MPM
...
from holographic.simulation_and_physics.holographic_mpm import MPMSnow as _mp_MPM, _bundle_mass_grid as _mp_bundle
...
from holographic.mesh_and_geometry.holographic_freesurface import FreeSurface as _fs_FS, seed_breaking_crest as _fs_seed
...
from holographic.misc.holographic_dendrite import ice_dendrite as _dl_ice, lightning as _dl_bolt
...
from holographic.simulation_and_physics.holographic_em import push_particle as _em_push, cyclotron_frequency as _em_wc, exb_drift as _em_drift, Maxwell1D as _em_Max
...
from holographic.rendering.holographic_photo3d import photo_to_gaussians as _p3
_p3_H = _p3_W = 48
...
from holographic.mesh_and_geometry.holographic_conformal import ConformalForecaster as _CFcast, AdaptiveConformal as _CFaci, conformal_quantile as _cf_q, coverage_report as _cf_cov, crps_sample as _cf_crps
...
from holographic.scene_and_pipeline.holographic_pipeline import PipelineConfig as _RSPCfg, build_pipeline as _rsp_build
from holographic.misc.holographic_fieldeffect import FieldEffect as _RSPFx, attract_to as _rsp_attract
from holographic.misc.holographic_integrate import ParticleSim as _RSPSim
from holographic.mesh_and_geometry.holographic_sdf import sphere as _rsp_sphere
...
from holographic.materials_and_texture.holographic_materialio import TextureMap as _S3LTex, PBRMaterial as _S3LMat
from holographic.simulation_and_physics.holographic_graph_memory import GraphMemory as _S3LGM
...
from holographic.io_and_interop.holographic_procbridge import procedural_compression as _pc_geo, soft_min as _sm_geo, fpe_smooth as _fs_geo
from holographic.mesh_and_geometry.holographic_sdf import sphere as _psph_geo, menger as _pmeng_geo
...
from holographic.sampling_and_signal.holographic_harmonic import harmonic_atom as _ha_geo, OnlineHarmonicAtom as _oha_geo
...
from holographic.scene_and_pipeline.holographic_orchestrator import chain_signature as _cs_geo, optimize_toolchain as _ot_geo
...
_ix = importlib.import_module("holographic.misc.holographic_unified").UnifiedMind(dim=256, seed=0)
_rng = _np.random.default_rng(0)
...
from holographic.scene_and_pipeline.holographic_plan import chunk_route as _cr, RouteIndex as _RI
...
from holographic.misc.holographic_tree import _tile_bucket as _tb
from holographic.rendering.holographic_splat import splat_bundle_tiled as _sbt, recall_region_tiled as _rrt, splat_fit as _sf
...
from holographic.misc.holographic_tree import StructuredIndex as _SI
