...
import numpy as np
from holographic_lights import (PointLight, DirectionalLight, AmbientLight, SpotLight, RectLight,
                                SphereLight, MeshLight, IESLight, load_ies, direct_lighting)
...
def test_disk_light_is_one_sided_and_round():
    rng = np.random.default_rng(0)
    from holographic_lights import DiskLight
