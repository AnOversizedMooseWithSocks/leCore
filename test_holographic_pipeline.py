...
def test_pipeline_renders_real_scene_matching_render_auto():
    import numpy as np
    from holographic_pipeline import build_pipeline, PipelineConfig
    from holographic_gbuffer import converge_samples, declfirefly, primary_gbuffer, render_auto
...
def test_pipeline_postfx_aces_grades_and_validates():
    import numpy as np
    from holographic_pipeline import build_pipeline, PipelineConfig, PipelineError
    spec = _tiny_real_scene()
...
def test_r1_strategies_dispatch():
    from holographic_pipeline import RenderSpec, FrameState, dispatch_render, RENDER_STRATEGIES
    scene, cam, mat, dark = _r1_scene()
...
def test_r1_needs_check_catches_missing_input():
    from holographic_pipeline import RenderSpec, FrameState, dispatch_render, PipelineError
    scene, cam, mat, dark = _r1_scene()
