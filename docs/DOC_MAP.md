...
## Family layout (712 modules)

```mermaid
graph LR
    H[holographic/]
    H --> misc["misc (150)"]
    H --> mesh["mesh_and_geometry (99)"]
    H --> io_a["io_and_interop (85)"]
    H --> agen["agents_and_reasoning (84)"]
    H --> rend["rendering (65)"]
    H --> samp["sampling_and_signal (58)"]
    H --> simu["simulation_and_physics (51)"]
    H --> cach["caching_and_storage (48)"]
