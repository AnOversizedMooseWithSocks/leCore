...
graph LR
    ...
    H --> rend["rendering (63)"]
    H --> agen["agents_and_reasoning (56)"]
    H --> simu["simulation_and_physics (49)"]
    H --> samp["sampling_and_signal (36)"]
    H --> io_a["io_and_interop (35)"]
    H --> scen["scene_and_pipeline (30)"]
    H --> cach["caching_and_storage (20)"]
