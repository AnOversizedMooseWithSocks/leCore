...
> **Coverage: 71 of 396 capabilities carry io-kind tags (17%).** The graph below is that tagged subset. Untagged capabilities are real but do not yet declare a typed edge -- backfilling tags grows the map.
