...
import numpy as np
from holographic_autobump import (image_to_height, normal_from_height, bump_confidence, auto_bump,
                                  flat_normal_map, pack_normal_rgb, quantize_normals, add_height_channel)
...
def test_octnormal_roundtrip():
    from holographic_octnormal import oct_decode
